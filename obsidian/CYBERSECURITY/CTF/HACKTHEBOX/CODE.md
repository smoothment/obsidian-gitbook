...
![](cybersecurity/images/Pasted%2520image%252020250324224713.png)

We got a python code execution, let's check the behavior:

![](cybersecurity/images/Pasted%2520image%252020250324225113.png)
...
![](cybersecurity/images/Pasted%2520image%252020250324225905.png)

We got the reverse shell, issue is that after some time, it gets closed automatically:

![](cybersecurity/images/Pasted%2520image%252020250324230045.png)
...
![](cybersecurity/images/Pasted%2520image%252020250324230546.png)

Let's download it in our machine and look at the contents with `sqlitebrowser`:

![](cybersecurity/images/Pasted%2520image%252020250324230620.png)

We got two users, but, looking at `/etc/passwd` we can see that `martin` is the user with a shell:

![](cybersecurity/images/Pasted%2520image%252020250324230723.png)

Let's crack the md5 hash:

![](cybersecurity/images/Pasted%2520image%252020250324230746.png)
...
![](cybersecurity/images/Pasted%2520image%252020250324230841.png)

Let's check our sudo privileges:

![](cybersecurity/images/Pasted%2520image%252020250324230915.png)
...
![](cybersecurity/images/Pasted%2520image%252020250324233308.png)
...
![](cybersecurity/images/Pasted%2520image%252020250324234117.png)

Nice, it worked, let's check if we're able to access the contents of it:

![](cybersecurity/images/Pasted%2520image%252020250324234139.png)
...
![](cybersecurity/images/Pasted%2520image%252020250324234355.png)
