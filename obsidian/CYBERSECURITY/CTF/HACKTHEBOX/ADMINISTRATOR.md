...
![](cybersecurity/images/Pasted%2520image%252020250116163132.png)

We can use `net users` to list all the users in this machine:

![](cybersecurity/images/Pasted%2520image%252020250116163210.png)
...
![](cybersecurity/images/Pasted%2520image%252020250116163543.png)

So, we can log using `evil-winrm` with the set credentials:


![](cybersecurity/images/Pasted%2520image%252020250116163724.png)
...
![](cybersecurity/images/Pasted%2520image%252020250116164218.png)
...
![](cybersecurity/images/Pasted%2520image%252020250116165415.png)

Nice, let's list all available shares using `smbmap`:

`smbmap -H 10.10.11.42 -u 'benjamin' -p 'benjaminPasword`

![](cybersecurity/images/Pasted%2520image%252020250116165547.png)


We have FTP enabled, let's use it to read files:

![](cybersecurity/images/Pasted%2520image%252020250116165908.png)

We got a `Backup.psafe3` file, let's download it on our local machine:


![](cybersecurity/images/Pasted%2520image%252020250116170832.png)
...
![](cybersecurity/images/Pasted%2520image%252020250116171307.png)
...
![](cybersecurity/images/Pasted%2520image%252020250116171455.png)
...
![](cybersecurity/images/Pasted%2520image%252020250116172606.png)

Let's get our user flag and begin privilege escalation:

![](cybersecurity/images/Pasted%2520image%252020250116173148.png)
...
![](cybersecurity/images/Pasted%2520image%252020250116181304.png)
...
![](cybersecurity/images/Pasted%2520image%252020250116181538.png)
```
...
![](cybersecurity/images/Pasted%2520image%252020250116181640.png)
