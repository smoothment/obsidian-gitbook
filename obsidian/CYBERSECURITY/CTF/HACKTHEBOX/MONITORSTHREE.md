...
![](Pasted%20image%2020250117151541.png)
...
![](Pasted%20image%2020250117152544.png)

We got a login page, we can try to fuzz a bit more: 

![](Pasted%20image%2020250117153123.png)
...
![](Pasted%20image%2020250117153315.png)

![](Pasted%20image%2020250117153335.png)
...
![](Pasted%20image%2020250117153418.png)

We got a `Forgot Password?` site:

![](Pasted%20image%2020250117153441.png)
...
![](Pasted%20image%2020250117153528.png)
...
![](Pasted%20image%2020250117153712.png)
...
![](Pasted%20image%2020250117154018.png)
...
![](Pasted%20image%2020250117160216.png)
...
![](Pasted%20image%2020250117160345.png)
...
![](Pasted%20image%2020250117160454.png)
...
![](Pasted%20image%2020250117160547.png)
...
![](Pasted%20image%2020250117160631.png)
...
![](Pasted%20image%2020250117160713.png)


We got the following: `admin：31a181c8372e3afc59dab863430610e8`

![](Pasted%20image%2020250117160754.png)
...
![](Pasted%20image%2020250117170018.png)
...
![](Pasted%20image%2020250117170504.png)

We found credentials for the `mysql` server, let's check what's inside:

![](Pasted%20image%2020250117170654.png)
...
![](Pasted%20image%2020250117171224.png)

We got it: `12345678910`, let's switch users:

![](Pasted%20image%2020250117171336.png)

Nice, next step would be reading `/.ssh/id-rsa`:

![](Pasted%20image%2020250117171445.png)

Let's copy it into a file and log in using ssh:

![](Pasted%20image%2020250117171613.png)

In this point, we can already view `user.txt`:

![](Pasted%20image%2020250117171636.png)
...
![](Pasted%20image%2020250117172157.png)
...
![](Pasted%20image%2020250117172442.png)

First, let's locate where `duplicati` is running on the machine:

![](Pasted%20image%2020250117172612.png)

We have `/opt/duplicati`:

![](Pasted%20image%2020250117172643.png)

![](Pasted%20image%2020250117172655.png)

Following the PoC, we need to download `Duplicati-server.sqlite`:

![](Pasted%20image%2020250117173054.png)

Nice, next step would be searching for a password, and a salt:

![](Pasted%20image%2020250117173615.png)

Let's check out `option`:

![](Pasted%20image%2020250117173635.png)

Next we need to follow is this:

![](Pasted%20image%2020250117173815.png)

![](Pasted%20image%2020250117173940.png)
...
![](Pasted%20image%2020250117184501.png)

![](Pasted%20image%2020250117184509.png)
...
![](Pasted%20image%2020250117184631.png)
