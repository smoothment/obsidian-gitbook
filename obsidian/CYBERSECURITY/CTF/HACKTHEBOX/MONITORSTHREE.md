...
![](../images/Pasted%20image%2020250117151541.png)
...
![](../images/Pasted%20image%2020250117152544.png)

We got a login page, we can try to fuzz a bit more: 

![](../images/Pasted%20image%2020250117153123.png)
...
![](../images/Pasted%20image%2020250117153315.png)

![](../images/Pasted%20image%2020250117153335.png)
...
![](../images/Pasted%20image%2020250117153418.png)

We got a `Forgot Password?` site:

![](../images/Pasted%20image%2020250117153441.png)
...
![](../images/Pasted%20image%2020250117153528.png)
...
![](../images/Pasted%20image%2020250117153712.png)
...
![](../images/Pasted%20image%2020250117154018.png)
...
![](../images/Pasted%20image%2020250117160216.png)
...
![](../images/Pasted%20image%2020250117160345.png)
...
![](../images/Pasted%20image%2020250117160454.png)
...
![](../images/Pasted%20image%2020250117160547.png)
...
![](../images/Pasted%20image%2020250117160631.png)
...
![](../images/Pasted%20image%2020250117160713.png)


We got the following: `admin：31a181c8372e3afc59dab863430610e8`

![](../images/Pasted%20image%2020250117160754.png)
...
![](../images/Pasted%20image%2020250117170018.png)
...
![](../images/Pasted%20image%2020250117170504.png)

We found credentials for the `mysql` server, let's check what's inside:

![](../images/Pasted%20image%2020250117170654.png)
...
![](../images/Pasted%20image%2020250117171224.png)

We got it: `12345678910`, let's switch users:

![](../images/Pasted%20image%2020250117171336.png)

Nice, next step would be reading `/.ssh/id-rsa`:

![](../images/Pasted%20image%2020250117171445.png)

Let's copy it into a file and log in using ssh:

![](../images/Pasted%20image%2020250117171613.png)

In this point, we can already view `user.txt`:

![](../images/Pasted%20image%2020250117171636.png)
...
![](../images/Pasted%20image%2020250117172157.png)
...
![](../images/Pasted%20image%2020250117172442.png)

First, let's locate where `duplicati` is running on the machine:

![](../images/Pasted%20image%2020250117172612.png)

We have `/opt/duplicati`:

![](../images/Pasted%20image%2020250117172643.png)

![](../images/Pasted%20image%2020250117172655.png)

Following the PoC, we need to download `Duplicati-server.sqlite`:

![](../images/Pasted%20image%2020250117173054.png)

Nice, next step would be searching for a password, and a salt:

![](../images/Pasted%20image%2020250117173615.png)

Let's check out `option`:

![](../images/Pasted%20image%2020250117173635.png)

Next we need to follow is this:

![](../images/Pasted%20image%2020250117173815.png)

![](../images/Pasted%20image%2020250117173940.png)
...
![](../images/Pasted%20image%2020250117184501.png)

![](../images/Pasted%20image%2020250117184509.png)
...
![](../images/Pasted%20image%2020250117184631.png)
