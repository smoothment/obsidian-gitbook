...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325120029.png)

Let's try exploring the website, for example, we got a `Download` section, if we click it, it downloads this:


![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325120505.png)

We get a `.zip` file, let's view its contents:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325120629.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325121543.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325122403.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325122545.png)

We got a File Upload vulnerability, let's read how the vulnerability works:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325122944.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325124601.png)

On the reconnaissance, we were able to find the following source codes:


![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325124709.png)

This means we need to modify the request in the following way:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325124830.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325130106.png)

After changing this, we can see the following:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325130141.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325142213.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325143143.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325143331.png)

Let's start by checking the users:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325144246.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325144416.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325144459.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325144706.png)

We got sudo privileges on `/usr/sbin/tcpdump`, let's check it out on `gtfobins`:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325144813.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325145323.png)

We got the root shell, let's read root flag:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325145422.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250325145445.png)
