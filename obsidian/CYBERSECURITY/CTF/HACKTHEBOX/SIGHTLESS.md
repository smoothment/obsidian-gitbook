...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250107170937.png)

`echo "10.10.11.32 sightless.htb" | sudo tee -a /etc/hosts 2>/dev/null`

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250107171213.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250107171349.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250107182931.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250107183525.png)

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250107183536.png)


Since we already have root access in the docker container, let's read `/etc/shadow` and get the hash for michael user:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250107183633.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250107184751.png)

Now we are inside of michael's account, we can read the user flag now:

```ad-note
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250107184841.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250107185646.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250107192250.png)
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250107192300.png)

```

Now, let's visit the page:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250107192343.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250107193550.png)

We got access to the panel, as seen, we have a php section, this has the following:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250107193639.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250107194238.png)

This is the root flag:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250107194255.png)
