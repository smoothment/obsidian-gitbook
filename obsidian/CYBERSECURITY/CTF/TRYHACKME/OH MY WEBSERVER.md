...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250324142059.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250324142413.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250324143146.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250324143438.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250324143608.png)

There we go, let's start, first, let's check the `/` directory to check if we're in a docker environment:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250324143717.png)

There we go, we are inside of a docker environment, let's check `/etc/hosts`:


![](CYBERSECURITY/IMAGES/Pasted%20image%2020250324143813.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250324144612.png)

We can find the `user.txt` file inside of the root folder:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250324144801.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250324145632.png)

Ports `5985` and `5986` are enabled, since `5985` is closed, we can check for some info regarding the other one:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250324145844.png)

We are dealing with OMI, let's search for an exploit:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250324145908.png)


Let's download the exploit and test the PoC:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250324150038.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250324150946.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250324151021.png)
