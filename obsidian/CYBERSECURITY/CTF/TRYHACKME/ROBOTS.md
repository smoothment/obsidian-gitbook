...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250314141610.png)

If we go to register, we can see this:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250314141630.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250314150509.png)

We get a redirection to `index.php`, we can also see something interesting in here:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250314150624.png)

We got something called `server_info`, something way too interesting in here is this:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250314150733.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250314181227.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317143641.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317143941.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317144124.png)


We can see this in our python server:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317144147.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317144245.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317151014.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317151210.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317151521.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317152103.png)

We got a stable shell now, let's look around, we got this:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317152134.png)

Got a `config.php` file, let's read it:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317152150.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317152505.png)

We found a `.dockerenv` file, this could mean we are inside of a docker environment, let's search `/etc/hosts`:


![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317152549.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317154806.png)


We can now access the db:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317155125.png)


We can find this inside the db:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317155227.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317155600.png)

If we use MD5 again:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317155615.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317155933.png)

Let's check our privileges:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317160010.png)

We can use `curl` with wildcard as the user `dolivaw`, let's check GTFOBINS:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317164324.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317164513.png)

But, what we need to find is who this file belongs to, either `dolivaw` or our user:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317164614.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317165458.png)

At this point we can read `user.txt` but let's continue onto root, let's check our privileges:


![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317165535.png)

Let's search this on GTFOBINS:


![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317165608.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250317170005.png)
