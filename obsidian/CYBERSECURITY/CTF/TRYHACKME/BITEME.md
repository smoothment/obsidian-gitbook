...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609145216.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609152202.png)

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609152210.png)

Now we got another issue, we need some way to bypass MFA, let's send the request to a proxy and check it:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609152348.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609152639.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609152951.png)

Ok, we got our `mfa` code, let's go into the panel:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609153036.png)

We got a `file browser` and `file viewer` functionality, the first one let's us list the files in the directory we specify:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609162434.png)

The file viewer, let us read the specific files, let's check if we can read `id_rsa`:


![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609162511.png)

We got fred and jason:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609162543.png)

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609162521.png)

Only Jason has `.ssh`:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609162601.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609162846.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609163806.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609164244.png)


![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609164300.png)

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609164312.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609164528.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609164917.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250609165033.png)
