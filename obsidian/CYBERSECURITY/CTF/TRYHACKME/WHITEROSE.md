...
sticker: emoji//1f4ae
---
![](cybersecurity/images/Pasted%2520image%252020241030205205.png)
# ENUMERATION


## OPEN PORTS

![](cybersecurity/images/Pasted%2520image%252020241031130806.png)

Let's explore the website:

![](cybersecurity/images/Pasted%2520image%252020241031130903.png)

So, we need to add `cyprusbank.thm` to `/etc/hosts`:

![](cybersecurity/images/Pasted%2520image%252020241031131009.png)

Once we've done that, let's try to look at the source code and fuzz the website:

![](cybersecurity/images/Pasted%2520image%252020241031131106.png)
Nothing useful, let's proceed with fuzzing

## FUZZING


![](cybersecurity/images/Pasted%2520image%252020241031131414.png)
...
![](cybersecurity/images/Pasted%2520image%252020241106150057.png)
...
![](cybersecurity/images/Pasted%2520image%252020241106150211.png)


![](cybersecurity/images/Pasted%2520image%252020241106150225.png)
...
![](cybersecurity/images/Pasted%2520image%252020241106150415.png)

We got some recent payments, let's investigate the page in order to get something useful:

![](cybersecurity/images/Pasted%2520image%252020241106151026.png)
...
![](cybersecurity/images/Pasted%2520image%252020241106151311.png)
...
![](cybersecurity/images/Pasted%2520image%252020241106151509.png)

Nice, we've logged in, let's go into settings:

![](cybersecurity/images/Pasted%2520image%252020241106151640.png)
...
![](cybersecurity/images/Pasted%2520image%252020241106151910.png)
```
...
![](cybersecurity/images/Pasted%2520image%252020241106160836.png)

![](cybersecurity/images/Pasted%2520image%252020241106160911.png)


![](cybersecurity/images/Pasted%2520image%252020241106160440.png)
...
![](cybersecurity/images/Pasted%2520image%252020241106161910.png)
...
![](cybersecurity/images/Pasted%2520image%252020241106162117.png)
...
![](cybersecurity/images/Pasted%2520image%252020241106162209.png)
...
![](cybersecurity/images/Pasted%2520image%252020241106162300.png)
...
![](cybersecurity/images/Pasted%2520image%252020241106162520.png)

If we did everything correctly, we are now able to run sudo as web in everything:

![](cybersecurity/images/Pasted%2520image%252020241106162632.png)

![](cybersecurity/images/Pasted%2520image%252020241106162646.png)
...
![](cybersecurity/images/Pasted%2520image%252020241106164116.png)
