...
![](cybersecurity/images/Pasted%2520image%252020250531142913.png)
...
![](cybersecurity/images/Pasted%2520image%252020250531145124.png)
...
![](cybersecurity/images/Pasted%2520image%252020250531145244.png)

Nice, with everything in order, let's check for a PE vector, we can use `linpeas` for that:

![](cybersecurity/images/Pasted%2520image%252020250531145442.png)
...
![](cybersecurity/images/Pasted%2520image%252020250531145755.png)
...
![](cybersecurity/images/Pasted%2520image%252020250531145921.png)

We got a shell as root. Inside of root's directory, we can find `b.txt`:

![](cybersecurity/images/Pasted%2520image%252020250531150016.png)

![](cybersecurity/images/Pasted%2520image%252020250531150056.png)
