...
![](cybersecurity/images/Pasted%2520image%252020250424125335.png)
...
![](cybersecurity/images/Pasted%2520image%252020250424125832.png)


![](cybersecurity/images/Pasted%2520image%252020250424125854.png)

![](cybersecurity/images/Pasted%2520image%252020250424125908.png)
...
![](cybersecurity/images/Pasted%2520image%252020250424130921.png)
...
![](cybersecurity/images/Pasted%2520image%252020250424131726.png)

Let's submit the request to our proxy:

![](cybersecurity/images/Pasted%2520image%252020250424131923.png)

As seen, we need the key we found earlier, let's use it and send the request again:

![](cybersecurity/images/Pasted%2520image%252020250424132020.png)
...
![](cybersecurity/images/Pasted%2520image%252020250424132423.png)
...
![](cybersecurity/images/Pasted%2520image%252020250424132609.png)


If we check the request:

![](cybersecurity/images/Pasted%2520image%252020250424132623.png)
...
![](cybersecurity/images/Pasted%2520image%252020250424132817.png)

We can try them out at `ssh`:


![](cybersecurity/images/Pasted%2520image%252020250424132948.png)
...
![](cybersecurity/images/Pasted%2520image%252020250424133902.png)

We got another user called `carlJ`, let's check if we can visualize its home:

![](cybersecurity/images/Pasted%2520image%252020250424133944.png)

We got a `.mozilla` folder, with this, we can use a tool called `firefox-decrypt`

![](cybersecurity/images/Pasted%2520image%252020250424134900.png)
...
![](cybersecurity/images/Pasted%2520image%252020250424135714.png)
...
![](cybersecurity/images/Pasted%2520image%252020250424140529.png)

We can now visualize the `mailing` directory:

![](cybersecurity/images/Pasted%2520image%252020250424143437.png)
...
![](cybersecurity/images/Pasted%2520image%252020250424145012.png)
...
![](cybersecurity/images/Pasted%2520image%252020250424145727.png)
...
![](cybersecurity/images/Pasted%2520image%252020250424145803.png)
...
![](cybersecurity/images/Pasted%2520image%252020250424145835.png)
