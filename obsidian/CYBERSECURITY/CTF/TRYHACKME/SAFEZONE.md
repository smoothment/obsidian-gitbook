...
![](Pasted%20image%2020250519124539.png)
...
![](Pasted%20image%2020250519125535.png)


Let's go to `register.php` to register an account:

![](Pasted%20image%2020250519125628.png)


![](Pasted%20image%2020250519125701.png)


We got some tabs, if we go to `news.php`, we can see this:

![](Pasted%20image%2020250519125732.png)

![](Pasted%20image%2020250519125742.png)

`contact.php` does not exist, let's go to `details.php`:

![](Pasted%20image%2020250519125820.png)

Inside of here, we can find this:

![](Pasted%20image%2020250519125840.png)


Based on the info, there seems to be some sort of `LFI` inside of here, let's use Caido:

![](Pasted%20image%2020250519130341.png)
...
![](Pasted%20image%2020250519131015.png)
...
![](Pasted%20image%2020250519203456.png)

As seen, we got `rce`, let's do the command from before then:

![](Pasted%20image%2020250519203554.png)

![](Pasted%20image%2020250519203603.png)

We got the request on our server, we only need to access the file through the `lfi` again and have our listener ready:

![](Pasted%20image%2020250519203655.png)

![](Pasted%20image%2020250519203704.png)
...
![](Pasted%20image%2020250519203804.png)
...
![](Pasted%20image%2020250519203911.png)
...
![](Pasted%20image%2020250519204031.png)
...
![](Pasted%20image%2020250519211619.png)

Let's use linpeas:

![](Pasted%20image%2020250519211933.png)
...
![](Pasted%20image%2020250519212024.png)
...
![](Pasted%20image%2020250519212359.png)

![](Pasted%20image%2020250519212410.png)
...
![](Pasted%20image%2020250519213847.png)
...
![](Pasted%20image%2020250519213957.png)
...
![](Pasted%20image%2020250519214356.png)
