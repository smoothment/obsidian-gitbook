...
![](../images/Pasted%20image%2020250610224830.png)

We got the key, use it to decode:

![](../images/Pasted%20image%2020250610231128.png)
...
![](../images/Pasted%20image%2020250610231410.png)
...
![](../images/Pasted%20image%2020250610232024.png)
...
![](../images/Pasted%20image%2020250610232117.png)
...
![](../images/Pasted%20image%2020250610232252.png)

Only the last one if not `sha256`, let's try to analyze it:

![](../images/Pasted%20image%2020250610232341.png)

This is hex encoded, we can decode it in the same website:

![](../images/Pasted%20image%2020250610232423.png)
...
![](../images/Pasted%20image%2020250610232612.png)
...
![](../images/Pasted%20image%2020250610233743.png)
Let's check valuable stuff for it, we can use `linpeas`:

![](../images/Pasted%20image%2020250610233939.png)
...
![](../images/Pasted%20image%2020250610234029.png)
...
![](../images/Pasted%20image%2020250610234200.png)
