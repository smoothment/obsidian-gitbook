...
![](cybersecurity/images/Pasted%2520image%252020250617125606.png)
...
![](cybersecurity/images/Pasted%2520image%252020250617125947.png)
...
![](cybersecurity/images/Pasted%2520image%252020250617132550.png)
...
![](cybersecurity/images/Pasted%2520image%252020250617132639.png)


![](cybersecurity/images/Pasted%2520image%252020250617132721.png)
...
![](cybersecurity/images/Pasted%2520image%252020250617153937.png)


Basically, we need to intercept the request and change a parameter, let's do it:

![](cybersecurity/images/Pasted%2520image%252020250617154114.png)

Click on Update Profile:

![](cybersecurity/images/Pasted%2520image%252020250617154612.png)
...
![](cybersecurity/images/Pasted%2520image%252020250617154700.png)

Once we send the request, we notice our dashboard changed:

![](cybersecurity/images/Pasted%2520image%252020250617154828.png)

We got new functionalities, we can get a shell through the `plugin editor`:

![](cybersecurity/images/Pasted%2520image%252020250617154915.png)
...
![](cybersecurity/images/Pasted%2520image%252020250617155345.png)



Save it and now we need to trigger it:

![](cybersecurity/images/Pasted%2520image%252020250617155131.png)

To trigger it, we need to go to `Installed Plugins` and activate it:


![](cybersecurity/images/Pasted%2520image%252020250617155159.png)

If we check our listener:

![](cybersecurity/images/Pasted%2520image%252020250617155405.png)
...
![](cybersecurity/images/Pasted%2520image%252020250617155558.png)

Now we're good to go, let's check users:

![](cybersecurity/images/Pasted%2520image%252020250617155642.png)

We only got `jack`, let's check his home:

![](cybersecurity/images/Pasted%2520image%252020250617155725.png)

We got a `reminder.txt` file:


![](cybersecurity/images/Pasted%2520image%252020250617155949.png)

They talking bout some backups, let's use linpeas to check that:

![](cybersecurity/images/Pasted%2520image%252020250617161259.png)

As seen, inside of `/var/backups` we can find the `id_rsa` for jack, let's grab it and get into ssh:

![](cybersecurity/images/Pasted%2520image%252020250617161410.png)
...
![](cybersecurity/images/Pasted%2520image%252020250617161855.png)
...
![](cybersecurity/images/Pasted%2520image%252020250617162155.png)

![](cybersecurity/images/Pasted%2520image%252020250617162303.png)
...
![](cybersecurity/images/Pasted%2520image%252020250617162534.png)

Now, save it and start the listener, once the script runs again, we will receive a shell:

![](cybersecurity/images/Pasted%2520image%252020250617162645.png)
...
![](cybersecurity/images/Pasted%2520image%252020250617162752.png)
