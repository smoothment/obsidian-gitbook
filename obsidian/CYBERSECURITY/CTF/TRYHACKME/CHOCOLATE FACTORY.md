...
![](../images/Pasted%20image%2020250408125722.png)


![](../images/Pasted%20image%2020250408125737.png)
...
![](../images/Pasted%20image%2020250408131240.png)

We can execute commands, let's try `id` for example:


![](../images/Pasted%20image%2020250408131309.png)
...
![](../images/Pasted%20image%2020250408131435.png)
...
![](../images/Pasted%20image%2020250408131704.png)

We can notice this at `/var/www/html`:

![](../images/Pasted%20image%2020250408132425.png)

There's something called `key_rev_key`, if we check the strings of it:

![](../images/Pasted%20image%2020250408132450.png)
...
![](../images/Pasted%20image%2020250408132656.png)
...
![](../images/Pasted%20image%2020250408132847.png)
...
![](../images/Pasted%20image%2020250408133050.png)

We got sudo permissions at `/usr/bin/vi`, let's check gtfobins:

![](../images/Pasted%20image%2020250408133125.png)
...
![](../images/Pasted%20image%2020250408133155.png)

There we go, we got root access, let's read `root.txt`:

![](../images/Pasted%20image%2020250408133322.png)

There's no `root.txt`, weird, let's check the contents of the root directory:

![](../images/Pasted%20image%2020250408133343.png)
...
![](../images/Pasted%20image%2020250408133737.png)
...
![](../images/Pasted%20image%2020250408134019.png)

If we get it and use steghide, we can see this:

![](../images/Pasted%20image%2020250408134124.png)
...
![](../images/Pasted%20image%2020250408140013.png)
...
![](../images/Pasted%20image%2020250408140034.png)
