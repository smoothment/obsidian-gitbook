...
![](../images/Pasted%20image%2020250206160927.png)
...
![](../images/Pasted%20image%2020250206161128.png)

We can do the same as the previous section:

![](../images/Pasted%20image%2020250206161204.png)
...
![](../images/Pasted%20image%2020250206161652.png)

We can see this:

![](../images/Pasted%20image%2020250206161856.png)

A lot of extensions work, let's simply go with `.phtml`, we need to upload our file like this:

![](../images/Pasted%20image%2020250206162328.png)

![](../images/Pasted%20image%2020250206161953.png)

Let's check our webshell:

![](../images/Pasted%20image%2020250206162337.png)

Now we can read `flag.txt`:

![](../images/Pasted%20image%2020250206162403.png)
