...
![](cybersecurity/images/Pasted%2520image%252020250122144803.png)

So, let's go into the site, and view the network tab:

![](cybersecurity/images/Pasted%2520image%252020250122144922.png)

If we reload the page, we see the following request being made:

![](cybersecurity/images/Pasted%2520image%252020250122144944.png)


If we double click on that `flag_327a6c4304ad5938eaf0efb6cc3e53dc.txt` resource, we see the following:

![](cybersecurity/images/Pasted%2520image%252020250122145010.png)
