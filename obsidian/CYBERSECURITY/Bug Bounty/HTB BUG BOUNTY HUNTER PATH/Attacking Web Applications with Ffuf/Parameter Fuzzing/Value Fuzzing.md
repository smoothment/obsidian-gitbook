...
# Question
---
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250129160543.png)

So, we need to create the `ids.txt` wordlist, let's use the following command:

`for i in $(seq 1 1000); do echo $i >> ids.txt; done`

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250129160645.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250129160803.png)
