...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250218145707.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250218150047.png)

As seen `allow_url_include` is enabled, let's check if `expect` is enabled too:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250218150131.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250218150502.png)
