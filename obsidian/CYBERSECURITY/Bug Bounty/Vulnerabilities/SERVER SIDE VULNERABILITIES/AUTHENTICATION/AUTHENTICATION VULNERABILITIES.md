...
![](cybersecurity/images/Pasted%2520image%252020240918171637.png)
...
![](cybersecurity/images/Pasted%2520image%252020240918172832.png)
Once we get the wordlist, we can brute force it either using the burp intruder, or, hydra:



![](cybersecurity/images/Pasted%2520image%252020240918173325.png)
We got the request, lets brute force our way in!:

![](cybersecurity/images/Pasted%2520image%252020240918181253.png)
...
![](cybersecurity/images/Pasted%2520image%252020240918181850.png)

Password is: `letmein`


![](cybersecurity/images/Pasted%2520image%252020240918181939.png)
...
![](cybersecurity/images/Pasted%2520image%252020240918182749.png)
When we login, we need a code sent to our email, if we go to email client, we get this:

![](cybersecurity/images/Pasted%2520image%252020240918183415.png)
Now we are at this panel and have this in the url:

![](cybersecurity/images/Pasted%2520image%252020240918183520.png)
...
![](cybersecurity/images/Pasted%2520image%252020240918183638.png)
...
![](cybersecurity/images/Pasted%2520image%252020240924132822.png)
...
![](cybersecurity/images/Pasted%2520image%252020240924165753.png)
![](cybersecurity/images/Pasted%2520image%252020240924165804.png)
Now, lets start the attack, I don't have the image but I also loaded in the user.txt file into the attack:

![](cybersecurity/images/Pasted%2520image%252020240924172441.png)
...
![](cybersecurity/images/Pasted%2520image%252020240924173635.png)
Password is: `computer`

Lets authenticate:

![](cybersecurity/images/Pasted%2520image%252020240924173740.png)
![](cybersecurity/images/Pasted%2520image%252020240924173817.png)

### LAB

![](cybersecurity/images/Pasted%2520image%252020240925125637.png)
...
![](cybersecurity/images/Pasted%2520image%252020240925130823.png)
Add the X-Forwarded-For position in our intruder and the following payload:

![](cybersecurity/images/Pasted%2520image%252020240925130920.png)
We will also need to add a second position for our usernames, like this:

![](cybersecurity/images/Pasted%2520image%252020240925131043.png)
![](cybersecurity/images/Pasted%2520image%252020240925131051.png)
![](cybersecurity/images/Pasted%2520image%252020240925144829.png)
We got username `adserver`, password is:
![](cybersecurity/images/Pasted%2520image%252020240925144855.png)
`thomas

Just like that, we finished the lab:

![](cybersecurity/images/Pasted%2520image%252020240925144938.png)
...
![](cybersecurity/images/Pasted%2520image%252020240926164118.png)
...
![](cybersecurity/images/Pasted%2520image%252020240926164910.png)
...
![](cybersecurity/images/Pasted%2520image%252020240926171117.png)


So, 2FA code is `0574

Lets try to authenticate using username carlos:
![](cybersecurity/images/Pasted%2520image%252020240926171143.png)

And we´re in:

![](cybersecurity/images/Pasted%2520image%252020240926171222.png)
![](cybersecurity/images/Pasted%2520image%252020240926171306.png)
...
![](cybersecurity/images/Pasted%2520image%252020240927125009.png)

Request:

![](cybersecurity/images/Pasted%2520image%252020240927130212.png)
If we use inspector tool from burp, we can see the base in which the stay-logged-in cookie is constructed:

![](cybersecurity/images/Pasted%2520image%252020240927130256.png)
...
![](cybersecurity/images/Pasted%2520image%252020240927131642.png)


![](cybersecurity/images/Pasted%2520image%252020240927130807.png)
![](cybersecurity/images/Pasted%2520image%252020240927130815.png)
![](cybersecurity/images/Pasted%2520image%252020240927132128.png)
Just like that we completed the lab:

![](cybersecurity/images/Pasted%2520image%252020240927132204.png)
...
![](cybersecurity/images/Pasted%2520image%252020240927132951.png)
As the description says, this lab is vulnerable to `XSS` in the comment section:

![](cybersecurity/images/Pasted%2520image%252020240927133904.png)
...
![](cybersecurity/images/Pasted%2520image%252020240927134249.png)
If we go to our exploit server logs, we can see this:

![](cybersecurity/images/Pasted%2520image%252020240927134413.png)
...
![](cybersecurity/images/Pasted%2520image%252020240927134607.png)
![](cybersecurity/images/Pasted%2520image%252020240927134616.png)
Like that, we got carlos user password!:

![](cybersecurity/images/Pasted%2520image%252020240927134712.png)
...
![](cybersecurity/images/Pasted%2520image%252020241001125644.png)
The moment I went to change my password, I got this request:

![](cybersecurity/images/Pasted%2520image%252020241001132822.png)
...
![](cybersecurity/images/Pasted%2520image%252020241001134344.png)
...
##### LAB 2
![](cybersecurity/images/Pasted%2520image%252020241001134523.png)

For this lab, we must modify the following request:

![](cybersecurity/images/Pasted%2520image%252020241001141030.png)
...
![](cybersecurity/images/Pasted%2520image%252020241001141510.png)
...
![](cybersecurity/images/Pasted%2520image%252020241001141620.png)

If we go to our exploit server logs, we can see this:

![](cybersecurity/images/Pasted%2520image%252020241001141818.png)

Seems like carlos clicked on the link and we got his password token, now, let's change his password:


![](cybersecurity/images/Pasted%2520image%252020241001142152.png)
![](cybersecurity/images/Pasted%2520image%252020241001143728.png)
...
![](cybersecurity/images/Pasted%2520image%252020241001144341.png)

When we go and change our password using our own account, we get this request:

![](cybersecurity/images/Pasted%2520image%252020241001145039.png)
...
![](cybersecurity/images/Pasted%2520image%252020241001145201.png)
...
![](cybersecurity/images/Pasted%2520image%252020241001145300.png)

Let's launch the attack:


![](cybersecurity/images/Pasted%2520image%252020241001164920.png)

Carlos password is taylor, let's log in:

![](cybersecurity/images/Pasted%2520image%252020241001165027.png)
