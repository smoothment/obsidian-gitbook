...
1. **XPath Queries in Applications:** Applications often use XPath queries to retrieve data from XML documents, such as user authentication details. For example:
    ...
    ![](CYBERSECURITY/IMAGES/Pasted%20image%2020240906200719.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020241010143247.png)
If we enter the payload, we've bypassed the login page:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020241010143256.png)
### FIRST WAY
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020241010143417.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020241010143522.png)

![](CYBERSECURITY/IMAGES/Pasted%20image%2020241010143532.png)

`'or position()=3 or '`

![](CYBERSECURITY/IMAGES/Pasted%20image%2020241010143607.png)
![](CYBERSECURITY/IMAGES/Pasted%20image%2020241010143623.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020241010144040.png)

![](CYBERSECURITY/IMAGES/Pasted%20image%2020241010144053.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020241010172508.png)
For example, if we modify the `f` parameter into this:

`RAMDOM+|+//text()`

![](CYBERSECURITY/IMAGES/Pasted%20image%2020241010172638.png)
We get the following response:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020241010172649.png)
So, seems like it works!

![](CYBERSECURITY/IMAGES/Pasted%20image%2020241010172834.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020241010180954.png)
![](CYBERSECURITY/IMAGES/Pasted%20image%2020241010181012.png)
