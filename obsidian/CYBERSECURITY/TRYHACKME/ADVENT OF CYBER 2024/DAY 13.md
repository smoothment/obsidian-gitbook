...
sticker: emoji//1f384
---
![](cybersecurity/images/Pasted%2520image%252020241213123610.png)
...
![](cybersecurity/images/Pasted%2520image%252020241213124219.png)
...
![](cybersecurity/images/Pasted%2520image%252020241213125042.png)

Intercept the request with burp and go back to the browser to click the track button:

![](cybersecurity/images/Pasted%2520image%252020241213125123.png)
...
![](cybersecurity/images/Pasted%2520image%252020241213125603.png)
...
![](cybersecurity/images/Pasted%2520image%252020241213130205.png)
...
![](cybersecurity/images/Pasted%2520image%252020241213130236.png)

Once we've changed that, click forward and turn the intercept off, once done, we get this output:

![](cybersecurity/images/Pasted%2520image%252020241213130457.png)
...
![](cybersecurity/images/Pasted%2520image%252020241213131110.png)

![](cybersecurity/images/Pasted%2520image%252020241213131117.png)

So, let's send it to repeater, turning off the interception and modify the `sender` parameter to `8` to check if it works:



![](cybersecurity/images/Pasted%2520image%252020241213131325.png)
