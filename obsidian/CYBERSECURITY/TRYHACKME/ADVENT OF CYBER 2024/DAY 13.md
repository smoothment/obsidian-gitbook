...
sticker: emoji//1f384
---
![](../images/Pasted%20image%2020241213123610.png)
...
![](../images/Pasted%20image%2020241213124219.png)
...
![](../images/Pasted%20image%2020241213125042.png)

Intercept the request with burp and go back to the browser to click the track button:

![](../images/Pasted%20image%2020241213125123.png)
...
![](../images/Pasted%20image%2020241213125603.png)
...
![](../images/Pasted%20image%2020241213130205.png)
...
![](../images/Pasted%20image%2020241213131110.png)

![](../images/Pasted%20image%2020241213131117.png)

So, let's send it to repeater, turning off the interception and modify the `sender` parameter to `8` to check if it works:



![](../images/Pasted%20image%2020241213131325.png)
