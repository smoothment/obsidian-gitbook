...
![](images/Pasted%20image%2020241203125638.png)
...
![](images/Pasted%20image%2020241203125919.png)

![](images/Pasted%20image%2020241203125958.png)
...
![](images/Pasted%20image%2020241203130252.png)
...
![](images/Pasted%20image%2020241203130504.png)

![](images/Pasted%20image%2020241203130513.png)

And I was right! We were able to log in as admin user, now, let's search for a way to upload the web shell:

![](images/Pasted%20image%2020241203130555.png)
...
![](images/Pasted%20image%2020241203130657.png)
...
![](images/Pasted%20image%2020241203131016.png)
...
![](images/Pasted%20image%2020241203131212.png)

As we can see, our `shell.php` file appears in there, if we check the request, we can see the following:

![](images/Pasted%20image%2020241203131249.png)

Let's visit the page:

![](images/Pasted%20image%2020241203131302.png)

Here we are!!

Let's get the contents of our `flag.txt`:

![](images/Pasted%20image%2020241203131332.png)

![](images/Pasted%20image%2020241203131343.png)
