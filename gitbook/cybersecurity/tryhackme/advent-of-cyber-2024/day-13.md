...
![](gitbook/cybersecurity/images/Pasted%20image%2020241213123610.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241213124219.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241213125042.png)

Intercept the request with burp and go back to the browser to click the track button:

![](gitbook/cybersecurity/images/Pasted%20image%2020241213125123.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241213125603.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241213130205.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241213130236.png)

Once we've changed that, click forward and turn the intercept off, once done, we get this output:

![](gitbook/cybersecurity/images/Pasted%20image%2020241213130457.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241213131110.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020241213131117.png)

So, let's send it to repeater, turning off the interception and modify the `sender` parameter to `8` to check if it works:

![](gitbook/cybersecurity/images/Pasted%20image%2020241213131325.png)
