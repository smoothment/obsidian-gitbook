...
As a penetration tester, it is important to first analyze the flow of the application. First, the user will browse through the products and add items of interest to their wishlist at `http://10.10.163.220/product.php`. Click on the `Add to Wishlist` under `Wareville's Jolly Cap`, as shown below: !\[]\(Pasted image 20241205131850.png)
