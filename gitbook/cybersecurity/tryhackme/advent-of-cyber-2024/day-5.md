...
![](images/Pasted%20image%2020241205130237.png)
...
As a penetration tester, it is important to first analyze the flow of the application. First, the user will browse through the products and add items of interest to their wishlist at `http://10.10.163.220/product.php`. Click on the `Add to Wishlist` under `Wareville's Jolly Cap`, as shown below: ![](images/Pasted%20image%2020241205131850.png)
...
![](images/Pasted%20image%2020241205131902.png)
...
![](images/Pasted%20image%2020241205131942.png)
...
![](images/Pasted%20image%2020241205132120.png)
...
![](images/Pasted%20image%2020241205132404.png)

After we send the request, this was the response:

![](images/Pasted%20image%2020241205132451.png)
...
![](images/Pasted%20image%2020241205132850.png)
...
![](images/Pasted%20image%2020241205132919.png)
...
![](images/Pasted%20image%2020241205133007.png)
...
![](images/Pasted%20image%2020241205133249.png)

Let's send the attack:

![](images/Pasted%20image%2020241205133352.png)
