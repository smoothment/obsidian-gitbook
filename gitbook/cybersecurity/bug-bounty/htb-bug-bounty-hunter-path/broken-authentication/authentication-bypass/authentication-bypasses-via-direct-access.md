...
![](gitbook/cybersecurity/images/Pasted%20image%2020250214180955.png)

Let's browse to `/admin.php` and see the request:

![](gitbook/cybersecurity/images/Pasted%20image%2020250214181248.png)

Let's `Do intercept -> Response to this request`

![](gitbook/cybersecurity/images/Pasted%20image%2020250214181316.png)

Now, let's simply change the status code to `200`:

![](gitbook/cybersecurity/images/Pasted%20image%2020250214181340.png)
