...
![](cybersecurity/images/Pasted%2520image%252020250215140214.png)

Let's begin by checking the website:

![](cybersecurity/images/Pasted%2520image%252020250215140227.png)

We have a login functionality, let's check it out:

![](cybersecurity/images/Pasted%2520image%252020250215140248.png)
...
![](cybersecurity/images/Pasted%2520image%252020250215140815.png)
...
![](cybersecurity/images/Pasted%2520image%252020250215155348.png)

We get `Invalid credentials`, what if we use an invalid user:

![](cybersecurity/images/Pasted%2520image%252020250215155424.png)
...
![](cybersecurity/images/Pasted%2520image%252020250215160432.png)
...
![](cybersecurity/images/Pasted%2520image%252020250215160533.png)
...
![](cybersecurity/images/Pasted%2520image%252020250215164723.png)
...
![](cybersecurity/images/Pasted%2520image%252020250215164842.png)

`Do intercept -> Response to this request`:

![](cybersecurity/images/Pasted%2520image%252020250215164923.png)

Now, change `Location` to `/profile.php`:

![](cybersecurity/images/Pasted%2520image%252020250215165100.png)

Forward and `Do intercept -> Response to this request` again:

![](cybersecurity/images/Pasted%2520image%252020250215165141.png)

We get a GET request, we need to intercept this one too and change status code to `200` and `location` to `/profile.php` again:

![](cybersecurity/images/Pasted%2520image%252020250215165225.png)

After forwarding the request, this happens:

![](cybersecurity/images/Pasted%2520image%252020250215165242.png)
...
![](cybersecurity/images/Pasted%2520image%252020250215165319.png)
