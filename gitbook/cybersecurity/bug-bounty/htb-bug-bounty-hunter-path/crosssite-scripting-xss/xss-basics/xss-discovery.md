...
![](images/Pasted%20image%2020250130170252.png)

If we go to the site, we encounter the following:

![](images/Pasted%20image%2020250130170348.png)

If we do a simple register, we can see the following URL:

![](images/Pasted%20image%2020250130170629.png)

Let's use XSStrike:

![](images/Pasted%20image%2020250130170807.png)
