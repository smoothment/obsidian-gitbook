...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250131143341.png)

Let's go into the site:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250131143354.png)

At first sight, we encounter a login page, we can pass the following query to check if it's vulnerable to SQLI:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250131143614.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250131144251.png)
