...
![](cybersecurity/images/Pasted%2520image%252020250217141132.png)

Let's check out the website:

![](cybersecurity/images/Pasted%2520image%252020250217141147.png)

We can see it's a file manager application, we can add files and delete them, let's try adding a file:

![](cybersecurity/images/Pasted%2520image%252020250217141216.png)

Now, if we try deleting a file, this happens:

![](cybersecurity/images/Pasted%2520image%252020250217141234.png)
...
![](cybersecurity/images/Pasted%2520image%252020250217141331.png)

First, it sends a `GET` request to `/admin/reset.php` endpoint, if we forward the request, we can see the following:

![](cybersecurity/images/Pasted%2520image%252020250217141414.png)

If we change the request method to `PUT`, this happens:


![](cybersecurity/images/Pasted%2520image%252020250217141751.png)

We no longer get `401` status code, let's send the request and check the behavior:

![](cybersecurity/images/Pasted%2520image%252020250217142846.png)
...
![](cybersecurity/images/Pasted%2520image%252020250217143156.png)
