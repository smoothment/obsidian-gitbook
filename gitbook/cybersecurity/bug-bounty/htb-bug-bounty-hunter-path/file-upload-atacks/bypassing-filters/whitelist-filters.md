...
![](gitbook/cybersecurity/images/Pasted%20image%2020250206154129.png)

We can begin by checking the website:

![](gitbook/cybersecurity/images/Pasted%20image%2020250206154226.png)

If we try uploading a `.php` file, we see the following:

![](gitbook/cybersecurity/images/Pasted%20image%2020250206154300.png)

We can only upload images, let's upload an image and modify the request:

![](gitbook/cybersecurity/images/Pasted%20image%2020250206154432.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250206154754.png)

Let's send the attack:

![](gitbook/cybersecurity/images/Pasted%20image%2020250206155322.png)

None of them worked, we missed something, let's go back to the normal request, and check it out:

![](gitbook/cybersecurity/images/Pasted%20image%2020250206155436.png)

We can erase the `CheckFile`, and change the `accept` to whitelist our `.php` extension:

![](gitbook/cybersecurity/images/Pasted%20image%2020250206155557.png)

Now we can upload a `.php` file:

![](gitbook/cybersecurity/images/Pasted%20image%2020250206155649.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020250206155837.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250206160325.png)

Once we've sent the attack, we can see the following:

![](gitbook/cybersecurity/images/Pasted%20image%2020250206160404.png)

Let's go with `.phar`, we can upload the file in the following way:

![](gitbook/cybersecurity/images/Pasted%20image%2020250206160445.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020250206160510.png)

Nice, let's check our webshell:

![](gitbook/cybersecurity/images/Pasted%20image%2020250206160533.png)

It worked, let's read `flag.txt`:

![](gitbook/cybersecurity/images/Pasted%20image%2020250206160551.png)
