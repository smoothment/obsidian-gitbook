...
![](gitbook/cybersecurity/images/Pasted%20image%2020250123162152.png)

Let's intercept the request and send it to burp:

![](gitbook/cybersecurity/images/Pasted%20image%2020250123162223.png)

We need to change it like this in order to read `flag.txt`:

![](gitbook/cybersecurity/images/Pasted%20image%2020250123162339.png)
