...
![](gitbook/cybersecurity/images/Pasted%252520image%25252020250218145707.png)
...
![](gitbook/cybersecurity/images/Pasted%252520image%25252020250218150047.png)

As seen `allow_url_include` is enabled, let's check if `expect` is enabled too:

![](gitbook/cybersecurity/images/Pasted%252520image%25252020250218150131.png)
...
![](gitbook/cybersecurity/images/Pasted%252520image%25252020250218150502.png)
