...
![raw\_request](https://academy.hackthebox.com/storage/modules/35/raw_request.png)
...
![raw\_response](https://academy.hackthebox.com/storage/modules/35/raw_response.png)
...
If we click on the Network tab and refresh the page, we should be able to see the list of requests sent by the page: ![devtools\_network\_requests](https://academy.hackthebox.com/storage/modules/35/devtools_network_requests.jpg)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250122144213.png)

We can perform: `curl -I target`

And we should get a response like the following:

![](gitbook/cybersecurity/images/Pasted%20image%2020250122144240.png)

So, answer is `2.4.41`:

![](gitbook/cybersecurity/images/Pasted%20image%2020250122144257.png)
