...
Resources over HTTP are accessed via a `URL`, which offers many more specifications than simply specifying a website we want to visit. Let's look at the structure of a URL: ![url\_structure](https://academy.hackthebox.com/storage/modules/35/url_structure.png)
...
![HTTP\_Flow](https://academy.hackthebox.com/storage/modules/35/HTTP_Flow.png)
