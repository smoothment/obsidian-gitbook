...
![](gitbook/cybersecurity/images/Pasted%20image%2020250122153703.png)

Let's send a request in the webserver:

![](gitbook/cybersecurity/images/Pasted%20image%2020250122153827.png)

We can now see the behavior of the application, let's use curl and check the flag:

![](gitbook/cybersecurity/images/Pasted%20image%2020250122154141.png)
