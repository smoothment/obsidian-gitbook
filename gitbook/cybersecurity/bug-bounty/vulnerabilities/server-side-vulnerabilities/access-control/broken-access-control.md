...
![](images/Pasted%20image%2020240918140537.png)
...
![](images/Pasted%20image%2020240918140944.png)

**Burp request**

![](images/Pasted%20image%2020240918141232.png)

We can send to repeater and change the GET request, lets try `robots.txt` to see if we can read it:

**Repeater**

![](images/Pasted%20image%2020240918141314.png)
...
![](images/Pasted%20image%2020240918141420.png)

And we can delete user `Carlos`:

![](images/Pasted%20image%2020240918141447.png)
...
![](images/Pasted%20image%2020240918143545.png)

**Source code:**

![](images/Pasted%20image%2020240918143926.png)

We found `/admin-t8859k`

**Deleting user:**

![](images/Pasted%20image%2020240918144012.png) ![](images/Pasted%20image%2020240918144028.png)
...
![](images/Pasted%20image%2020240918144413.png)

**Login**

![](images/Pasted%20image%2020240918144608.png)

When we login, we can find this in burp:

If we pass the request to burp, we get this:

![](images/Pasted%20image%2020240918163348.png)

If we change: `Admin=true` we are now able to access `/admin` panel:

![](images/Pasted%20image%2020240918163719.png) ![](images/Pasted%20image%2020240918163807.png) ![](images/Pasted%20image%2020240918163942.png) There we go, we can now access the panel and delete username Carlos.
...
![](images/Pasted%20image%2020240918165253.png)
...
![](images/Pasted%20image%2020240918165829.png)

![](images/Pasted%20image%2020240918165853.png) We can see our admin userID right there, lets change it from our account to finish the lab:

![](images/Pasted%20image%2020240918165954.png) But careful, if we try to submit this API key, we will get an error because we need `carlos` API not admin, so lets, repeat exercise but with a post from `carlos`: ![](images/Pasted%20image%2020240918170150.png) ![](images/Pasted%20image%2020240918170220.png)
...
![](images/Pasted%20image%2020240918170422.png)

When we login, we can find that we can change our account id: ![](images/Pasted%20image%2020240918170659.png)
...
![](images/Pasted%20image%2020240918171009.png)

If we login with that password, we are inside admin account: ![](images/Pasted%20image%2020240918171340.png) ![](images/Pasted%20image%2020240918171346.png) ![](images/Pasted%20image%2020240918171355.png)
