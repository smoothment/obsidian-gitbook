...
![](cybersecurity/images/Pasted%2520image%252020241003150422.png)
...
![](cybersecurity/images/Pasted%2520image%252020241003151233.png)
I tried resetting the username carlos password making use of the function, but got the following response:

![](cybersecurity/images/Pasted%2520image%252020241003151756.png)
So, I asked about the `debug_sql` function:

![](cybersecurity/images/Pasted%2520image%252020241003152047.png)
We are able to execute commands on the SQL database, let's delete carlos:

`DELETE FROM users WHERE username = 'carlos';`
\
![](cybersecurity/images/Pasted%2520image%252020241003152227.png)
...
![](cybersecurity/images/Pasted%2520image%252020241003152523.png)
...
![](cybersecurity/images/Pasted%2520image%252020241003153402.png)
Seems like it can send us things, let's try to OS inject that:

![](cybersecurity/images/Pasted%2520image%252020241003153538.png)![](cybersecurity/images/Pasted%2520image%252020241003153544.png)
...
![](cybersecurity/images/Pasted%2520image%252020241003153653.png)
...
![](cybersecurity/images/Pasted%2520image%252020241003153832.png)

Like that, lab's solved:

![](cybersecurity/images/Pasted%2520image%252020241003153902.png)

# Indirect prompt injection
![](cybersecurity/images/Pasted%2520image%252020241003154041.png)
...
![](cybersecurity/images/Pasted%2520image%252020241003160835.png)

To begin, we must register an account using our email client:

![](cybersecurity/images/Pasted%2520image%252020241003161014.png)

Let's ask the AI chat about its APIs:

![](cybersecurity/images/Pasted%2520image%252020241003161107.png)
...
![](cybersecurity/images/Pasted%2520image%252020241003161313.png)
...
![](cybersecurity/images/Pasted%2520image%252020241003161558.png)
...
![](cybersecurity/images/Pasted%2520image%252020241003161844.png)
![](cybersecurity/images/Pasted%2520image%252020241003161918.png)
...
![](cybersecurity/images/Pasted%2520image%252020241003162236.png)
![](cybersecurity/images/Pasted%2520image%252020241003162328.png)

If we wait a couple minutes, we will solve the lab by deleting carlos account:

![](cybersecurity/images/Pasted%2520image%252020241003162400.png)
...
![](cybersecurity/images/Pasted%2520image%252020241003163436.png)
