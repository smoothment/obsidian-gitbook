...
![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003150422.png)
...
![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003151233.png)
I tried resetting the username carlos password making use of the function, but got the following response:

![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003151756.png)
So, I asked about the `debug_sql` function:

![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003152047.png)
We are able to execute commands on the SQL database, let's delete carlos:

`DELETE FROM users WHERE username = 'carlos';`
\
![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003152227.png)
...
![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003152523.png)
...
![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003153402.png)
Seems like it can send us things, let's try to OS inject that:

![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003153538.png)![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003153544.png)
...
![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003153653.png)
...
![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003153832.png)

Like that, lab's solved:

![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003153902.png)

# Indirect prompt injection
![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003154041.png)
...
![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003160835.png)

To begin, we must register an account using our email client:

![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003161014.png)

Let's ask the AI chat about its APIs:

![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003161107.png)
...
![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003161313.png)
...
![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003161558.png)
...
![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003161844.png)
![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003161918.png)
...
![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003162236.png)
![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003162328.png)

If we wait a couple minutes, we will solve the lab by deleting carlos account:

![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003162400.png)
...
![](gitbook/cybersecurity/images/Pasted%252520image%25252020241003163436.png)
