...
![](gitbook/cybersecurity/images/Pasted%20image%2020240919153000.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240919153543.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240919154556.png) Once we've done that, we can get a prior access to admin panel, if we try to delete carlos user, we'll fail, so, we need now to change the stockAPI to the url we get once we try to delete the user, being that: `/localhost/admin/delete?username=carlos`, and like that, we will finish the lab ![](gitbook/cybersecurity/images/Pasted%20image%2020240919154631.png) ![](gitbook/cybersecurity/images/Pasted%20image%2020240919154917.png) ![](gitbook/cybersecurity/images/Pasted%20image%2020240919154954.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240919155630.png)

Send the request to intruder to brute force the ip: ![](gitbook/cybersecurity/images/Pasted%20image%2020240919155926.png) ![](gitbook/cybersecurity/images/Pasted%20image%2020240919162207.png) So, the IP address is: 192.168.0.80, lets modify the request in burp to delete carlos username: ![](gitbook/cybersecurity/images/Pasted%20image%2020240919162331.png) ![](gitbook/cybersecurity/images/Pasted%20image%2020240919162504.png)

## TRYHACKME EXPLANATION

### SSRF EXAMPLES

![](gitbook/cybersecurity/images/Pasted%20image%2020241106093933.png)

**WITH A LITTLE BIT OF PATH TRAVERSAL**

![](gitbook/cybersecurity/images/Pasted%20image%2020241106094005.png)

**MAKING USE OF \&X=**

![](gitbook/cybersecurity/images/Pasted%20image%2020241106094026.png)

**TAKEOVER**

***

![](gitbook/cybersecurity/images/Pasted%20image%2020241106094119.png)

#### PRACTICAL EXAMPLE

***

![](gitbook/cybersecurity/images/Pasted%20image%2020241106094211.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241106094312.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241106095157.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241106095947.png)

**GOING TO `/customers/new-account-page`**

![](gitbook/cybersecurity/images/Pasted%20image%2020241106100041.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241106100642.png)

Nice, let's update the avatar and see the page source:

![](gitbook/cybersecurity/images/Pasted%20image%2020241106100711.png)

We got a `base64` we need to decode, let's use [cyberchef](https://gchq.github.io/CyberChef/):

![](gitbook/cybersecurity/images/Pasted%20image%2020241106100748.png)
