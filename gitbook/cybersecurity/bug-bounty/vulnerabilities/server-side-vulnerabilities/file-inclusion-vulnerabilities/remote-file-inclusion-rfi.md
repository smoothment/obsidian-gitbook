...
![](gitbook/cybersecurity/images/Pasted%20image%2020241105181015.png)

We need to go into inspector and change the method from `GET` to `POST`

![](gitbook/cybersecurity/images/Pasted%20image%2020241105181107.png)

Once we've changed that, send the request to burp and modify the value to POST:

![](gitbook/cybersecurity/images/Pasted%20image%2020241105181139.png)

Once that is done, we will be able to retrieve the flag:

![](gitbook/cybersecurity/images/Pasted%20image%2020241105181202.png)

### SECOND

![](gitbook/cybersecurity/images/Pasted%20image%2020241105181228.png)

Seems like something related to the cookies, let's look at them:

![](gitbook/cybersecurity/images/Pasted%20image%2020241105181327.png)

Let's try changing the cookies to `admin`:

![](gitbook/cybersecurity/images/Pasted%20image%2020241105181413.png)

Nice, we were able to bypass that, let's get our flag:

![](gitbook/cybersecurity/images/Pasted%20image%2020241105181626.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241105181803.png)

And just like that, challenge 2 is done!

### THIRD

![](gitbook/cybersecurity/images/Pasted%20image%2020241105181938.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241105182048.png)

Hmm, something weird happened let's check at inspector tab to view if the request is actually a post request:

![](gitbook/cybersecurity/images/Pasted%20image%2020241105182134.png)

And this is where the issue relies, let's change it to post:

![](gitbook/cybersecurity/images/Pasted%20image%2020241105182747.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020241105182754.png)

Now, let's give the previous payload to the file section:

![](gitbook/cybersecurity/images/Pasted%20image%2020241105182811.png)

Let's send the request:

![](gitbook/cybersecurity/images/Pasted%20image%2020241105182825.png)

Nice, we got the flag!

### FOURTH

![](gitbook/cybersecurity/images/Pasted%20image%2020241105182924.png)

We need to gain RCE in that section, let's check:

![](gitbook/cybersecurity/images/Pasted%20image%2020241105182954.png)

First, let's create a file with the following php code saved as a txt file:

`<?php echo exec("hostname");?>`

![](gitbook/cybersecurity/images/Pasted%20image%2020241105183103.png)
