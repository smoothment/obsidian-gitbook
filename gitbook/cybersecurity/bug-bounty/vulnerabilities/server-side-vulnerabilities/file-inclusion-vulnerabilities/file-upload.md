...
![](gitbook/cybersecurity/images/Pasted%20image%2020240919170230.png) We'll upload a simple Web shell to read contents from secret directory: ![](gitbook/cybersecurity/images/Pasted%20image%2020240919171649.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020240919171719.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020240919171734.png)

Lets use burp to test if it worked:

![](gitbook/cybersecurity/images/Pasted%20image%2020240919171851.png) And it worked, now we can read the contents of the directory:

![](gitbook/cybersecurity/images/Pasted%20image%2020240919172108.png) We need to use URL encode for space: `%20` for it to work correctly, and like that, we finished the lab.

![](gitbook/cybersecurity/images/Pasted%20image%2020240919172507.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240919173553.png) We will upload a webshell in php changing the content-type to a image/jpeg or image/png: ![](gitbook/cybersecurity/images/Pasted%20image%2020240919174011.png) Once we do it, we see that we were able to upload it: ![](gitbook/cybersecurity/images/Pasted%20image%2020240919174029.png) Lets visit the website and try to perform RCE:

![](gitbook/cybersecurity/images/Pasted%20image%2020240919174130.png) And it worked, now lets read the content of `/home/carlos/secret`:

![](gitbook/cybersecurity/images/Pasted%20image%2020240919174207.png) Just like that, we completed the lab:

![](gitbook/cybersecurity/images/Pasted%20image%2020240919174240.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240923144452.png) First, the request is the following: ![](gitbook/cybersecurity/images/Pasted%20image%2020240923145605.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240923145814.png) Meaning, i successfully uploaded the webshell, and can now retrieve carlos secret:

![](gitbook/cybersecurity/images/Pasted%20image%2020240923145918.png) And like that, the lab is done: ![](gitbook/cybersecurity/images/Pasted%20image%2020240923150011.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240923150707.png) ![](gitbook/cybersecurity/images/Pasted%20image%2020240923151141.png) I was able to upload the `.php5` file, now, i got to change the `.htaccess` file for it to be able to execute my `php` file:

![](gitbook/cybersecurity/images/Pasted%20image%2020240923152137.png) For it, i added a functionality which executes `.php5` files, and i changed the `content-type` to `text/plain`:

`AddType application/x-httpd-php .php5`

`Content-Type: text/plain`

![](gitbook/cybersecurity/images/Pasted%20image%2020240923152416.png) And just like that, we uploaded the webshell, if we read carlos secret we get this:

![](gitbook/cybersecurity/images/Pasted%20image%2020240923152453.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020240923152548.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240923153104.png) I used the following payloads: ![](gitbook/cybersecurity/images/Pasted%20image%2020240923153433.png) Only two gave me `200` STATUS CODE, lets check the response:

![](gitbook/cybersecurity/images/Pasted%20image%2020240923153507.png) Lets see if this webshell worked: ![](gitbook/cybersecurity/images/Pasted%20image%2020240923153708.png) And it failed, but, what if we try to null byte that to see if it works:

![](gitbook/cybersecurity/images/Pasted%20image%2020240923153748.png) And it worked!

Lets see our webshell:

![](gitbook/cybersecurity/images/Pasted%20image%2020240923153905.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020240923153953.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240923154250.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240923161046.png)

If i go to the path, i get this: ![](gitbook/cybersecurity/images/Pasted%20image%2020240923161122.png)

And, as we can see, we can read the content, it is highlighted between START and END: ![](gitbook/cybersecurity/images/Pasted%20image%2020240923161213.png)
