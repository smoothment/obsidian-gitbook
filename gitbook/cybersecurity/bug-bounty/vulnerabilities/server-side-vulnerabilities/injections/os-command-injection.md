...
!\[]\(Pasted image 20240919175442.png) Lets OS inject parameter storeId using a pipeline `|` so it performs a command right after the first one:

!\[]\(Pasted image 20240919175714.png) !\[]\(Pasted image 20240919175733.png)
