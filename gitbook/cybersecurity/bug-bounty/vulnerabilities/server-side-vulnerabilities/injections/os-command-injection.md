...
![](Pasted%20image%2020240919175442.png) Lets OS inject parameter storeId using a pipeline `|` so it performs a command right after the first one:

![](Pasted%20image%2020240919175714.png) ![](Pasted%20image%2020240919175733.png)
