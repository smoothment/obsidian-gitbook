...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240918171637.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240918172832.png)
Once we get the wordlist, we can brute force it either using the burp intruder, or, hydra:



![](CYBERSECURITY/IMAGES/Pasted%20image%2020240918173325.png)
We got the request, lets brute force our way in!:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020240918181253.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240918181850.png)

Password is: `letmein`


![](CYBERSECURITY/IMAGES/Pasted%20image%2020240918181939.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240918182749.png)
When we login, we need a code sent to our email, if we go to email client, we get this:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020240918183415.png)
Now we are at this panel and have this in the url:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020240918183520.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240918183638.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240924132822.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240924165753.png)
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240924165804.png)
Now, lets start the attack, I don't have the image but I also loaded in the user.txt file into the attack:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020240924172441.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240924173635.png)
Password is: `computer`

Lets authenticate:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020240924173740.png)
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240924173817.png)

### LAB

![](CYBERSECURITY/IMAGES/Pasted%20image%2020240925125637.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240925130823.png)
Add the X-Forwarded-For position in our intruder and the following payload:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020240925130920.png)
We will also need to add a second position for our usernames, like this:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020240925131043.png)
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240925131051.png)
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240925144829.png)
We got username `adserver`, password is:
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240925144855.png)
`thomas

Just like that, we finished the lab:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020240925144938.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240926164118.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240926164910.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240926171117.png)


So, 2FA code is `0574

Lets try to authenticate using username carlos:
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240926171143.png)

And we´re in:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020240926171222.png)
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240926171306.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240927125009.png)

Request:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020240927130212.png)
If we use inspector tool from burp, we can see the base in which the stay-logged-in cookie is constructed:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020240927130256.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240927131642.png)


![](CYBERSECURITY/IMAGES/Pasted%20image%2020240927130807.png)
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240927130815.png)
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240927132128.png)
Just like that we completed the lab:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020240927132204.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240927132951.png)
As the description says, this lab is vulnerable to `XSS` in the comment section:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020240927133904.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240927134249.png)
If we go to our exploit server logs, we can see this:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020240927134413.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240927134607.png)
![](CYBERSECURITY/IMAGES/Pasted%20image%2020240927134616.png)
Like that, we got carlos user password!:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020240927134712.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020241001125644.png)
The moment I went to change my password, I got this request:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020241001132822.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020241001134344.png)
...
##### LAB 2
![](CYBERSECURITY/IMAGES/Pasted%20image%2020241001134523.png)

For this lab, we must modify the following request:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020241001141030.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020241001141510.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020241001141620.png)

If we go to our exploit server logs, we can see this:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020241001141818.png)

Seems like carlos clicked on the link and we got his password token, now, let's change his password:


![](CYBERSECURITY/IMAGES/Pasted%20image%2020241001142152.png)
![](CYBERSECURITY/IMAGES/Pasted%20image%2020241001143728.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020241001144341.png)

When we go and change our password using our own account, we get this request:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020241001145039.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020241001145201.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020241001145300.png)

Let's launch the attack:


![](CYBERSECURITY/IMAGES/Pasted%20image%2020241001164920.png)

Carlos password is taylor, let's log in:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020241001165027.png)
