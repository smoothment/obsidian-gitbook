...
![](gitbook/cybersecurity/images/Pasted%20image%2020240918171637.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240918172832.png) Once we get the wordlist, we can brute force it either using the burp intruder, or, hydra:

![](gitbook/cybersecurity/images/Pasted%20image%2020240918173325.png) We got the request, lets brute force our way in!:

![](gitbook/cybersecurity/images/Pasted%20image%2020240918181253.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240918181850.png)

Password is: `letmein`

![](gitbook/cybersecurity/images/Pasted%20image%2020240918181939.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240918182749.png) When we login, we need a code sent to our email, if we go to email client, we get this:

![](gitbook/cybersecurity/images/Pasted%20image%2020240918183415.png) Now we are at this panel and have this in the url:

![](gitbook/cybersecurity/images/Pasted%20image%2020240918183520.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240918183638.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240924132822.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240924165753.png) ![](gitbook/cybersecurity/images/Pasted%20image%2020240924165804.png) Now, lets start the attack, I don't have the image but I also loaded in the user.txt file into the attack:

![](gitbook/cybersecurity/images/Pasted%20image%2020240924172441.png) Username `americas` has a slightly different warning than the others, we could assume this is our username, lets brute force the password: ![](gitbook/cybersecurity/images/Pasted%20image%2020240924173635.png) Password is: `computer`

Lets authenticate:

![](gitbook/cybersecurity/images/Pasted%20image%2020240924173740.png) ![](gitbook/cybersecurity/images/Pasted%20image%2020240924173817.png)

#### LAB

![](gitbook/cybersecurity/images/Pasted%20image%2020240925125637.png) This lab contains some sort of IP anti brute force control that we must bypass, to do this, we must add the following header into our request:
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240925130823.png) Add the X-Forwarded-For position in our intruder and the following payload:

![](gitbook/cybersecurity/images/Pasted%20image%2020240925130920.png) We will also need to add a second position for our usernames, like this:

![](gitbook/cybersecurity/images/Pasted%20image%2020240925131043.png) ![](gitbook/cybersecurity/images/Pasted%20image%2020240925131051.png) ![](gitbook/cybersecurity/images/Pasted%20image%2020240925144829.png) We got username `adserver`, password is: ![](gitbook/cybersecurity/images/Pasted%20image%2020240925144855.png) \`thomas

Just like that, we finished the lab:

![](gitbook/cybersecurity/images/Pasted%20image%2020240925144938.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240926164118.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240926164910.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240926171117.png)

So, 2FA code is \`0574

Lets try to authenticate using username carlos: ![](gitbook/cybersecurity/images/Pasted%20image%2020240926171143.png)

And we´re in:

![](gitbook/cybersecurity/images/Pasted%20image%2020240926171222.png) ![](gitbook/cybersecurity/images/Pasted%20image%2020240926171306.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240927125009.png)

Request:

![](gitbook/cybersecurity/images/Pasted%20image%2020240927130212.png) If we use inspector tool from burp, we can see the base in which the stay-logged-in cookie is constructed:

![](gitbook/cybersecurity/images/Pasted%20image%2020240927130256.png)

It follows this structure: base64(username+':'md5HashOfPassword)\`

So, we need to send that request to intruder and do this: ![](gitbook/cybersecurity/images/Pasted%20image%2020240927131642.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020240927130807.png) ![](gitbook/cybersecurity/images/Pasted%20image%2020240927130815.png) ![](gitbook/cybersecurity/images/Pasted%20image%2020240927132128.png) Just like that we completed the lab:

![](gitbook/cybersecurity/images/Pasted%20image%2020240927132204.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240927132951.png) As the description says, this lab is vulnerable to `XSS` in the comment section:

![](gitbook/cybersecurity/images/Pasted%20image%2020240927133904.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240927134249.png) If we go to our exploit server logs, we can see this:

![](gitbook/cybersecurity/images/Pasted%20image%2020240927134413.png) Seems like a secret (cookie) from our victim:
...
![](gitbook/cybersecurity/images/Pasted%20image%2020240927134607.png) ![](gitbook/cybersecurity/images/Pasted%20image%2020240927134616.png) Like that, we got carlos user password!:

![](gitbook/cybersecurity/images/Pasted%20image%2020240927134712.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241001125644.png) The moment I went to change my password, I got this request:

![](gitbook/cybersecurity/images/Pasted%20image%2020241001132822.png) That's when I changed the username value from `wiener` to `carlos`, I got 302 request code, let's see if it changed carlos password:

![](gitbook/cybersecurity/images/Pasted%20image%2020241001134344.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241001134523.png)

For this lab, we must modify the following request:

![](gitbook/cybersecurity/images/Pasted%20image%2020241001141030.png) As the lab said, we must steal carlos token to reset his password, for this, I modified the request with the following header:

`X-Forwarded-Host`

Simple explanation of this header:

![](gitbook/cybersecurity/images/Pasted%20image%2020241001141510.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241001141620.png)

If we go to our exploit server logs, we can see this:

![](gitbook/cybersecurity/images/Pasted%20image%2020241001141818.png)

Seems like carlos clicked on the link and we got his password token, now, let's change his password:

![](gitbook/cybersecurity/images/Pasted%20image%2020241001142152.png) ![](gitbook/cybersecurity/images/Pasted%20image%2020241001143728.png) Like that, we finished the lab.
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241001144341.png)

When we go and change our password using our own account, we get this request:

![](gitbook/cybersecurity/images/Pasted%20image%2020241001145039.png) If we set different values for password1 and password 2, we get the message:

`New passowrds do not match`

Knowing this, we can brute force carlos password in the following way:

![](gitbook/cybersecurity/images/Pasted%20image%2020241001145201.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241001145300.png)

Let's launch the attack:

![](gitbook/cybersecurity/images/Pasted%20image%2020241001164920.png)

Carlos password is taylor, let's log in:

![](gitbook/cybersecurity/images/Pasted%20image%2020241001165027.png)
