...
![](cybersecurity/images/Pasted%2520image%252020241121130533.png)
...
![](cybersecurity/images/Pasted%2520image%252020241121130647.png)
...
![](cybersecurity/images/Pasted%2520image%252020241121131319.png)
...
![](cybersecurity/images/Pasted%2520image%252020241121131700.png)

Let's get them all using `mget *`

We'll analyze those files later, let's get our `attention.txt` file:

![](cybersecurity/images/Pasted%2520image%252020241121131803.png)

Nice, let's analyze those files:

#### `attention.txt`
----
![](cybersecurity/images/Pasted%2520image%252020241121131952.png)
...
![](cybersecurity/images/Pasted%2520image%252020241121132133.png)
...
![](cybersecurity/images/Pasted%2520image%252020241121134127.png)
...
![](cybersecurity/images/Pasted%2520image%252020241121134245.png)
Same interesting directory again, let's scan with `dirb`

### dirb
---
![](cybersecurity/images/Pasted%2520image%252020241121134211.png)

Found the `squirrelmail` directory again, seems like this is our way to go, let's visit it.
```

![](cybersecurity/images/Pasted%2520image%252020241121134448.png)
...
![](cybersecurity/images/Pasted%2520image%252020241121134929.png)

![](cybersecurity/images/Pasted%2520image%252020241121134940.png)
...
![](cybersecurity/images/Pasted%2520image%252020241121135155.png)
...
![](cybersecurity/images/Pasted%2520image%252020241121135455.png)
...
![](cybersecurity/images/Pasted%2520image%252020241121135646.png)
...
![](cybersecurity/images/Pasted%2520image%252020241121140644.png)
...
![](cybersecurity/images/Pasted%2520image%252020241121140728.png)

This is running `Cuppa` if we use searchsploit we get this:

![](cybersecurity/images/Pasted%2520image%252020241121140810.png)
...
![](cybersecurity/images/Pasted%2520image%252020241121142014.png)
...
![](cybersecurity/images/Pasted%2520image%252020241121142636.png)
![](cybersecurity/images/Pasted%2520image%252020241121142641.png)
We got our shell.
...
![](cybersecurity/images/Pasted%2520image%252020241121143025.png)
...
![](cybersecurity/images/Pasted%2520image%252020241121143321.png)

User `root` is running a script inside of `milesdyson` home called `backup.sh` let's check if we are able to write in it:

![](cybersecurity/images/Pasted%2520image%252020241121143414.png)

![](cybersecurity/images/Pasted%2520image%252020241121143635.png)
...
![](cybersecurity/images/Pasted%2520image%252020241121144618.png)
![](cybersecurity/images/Pasted%2520image%252020241121144743.png)
