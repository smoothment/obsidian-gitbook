...
![](cybersecurity/images/Pasted%2520image%252020250331160802.png)

We got a `login`, `signup`, also, we can check items:

![](cybersecurity/images/Pasted%2520image%252020250331160825.png)

Let's try creating a test account to check if we got any more functionalities:

![](cybersecurity/images/Pasted%2520image%252020250331160919.png)

We got some new stuff: `New Listing` and `Messages`, if we check the first one, we can see this:

![](cybersecurity/images/Pasted%2520image%252020250331160953.png)
...
![](cybersecurity/images/Pasted%2520image%252020250331161102.png)

If we submit the query:

![](cybersecurity/images/Pasted%2520image%252020250331161110.png)
...
![](cybersecurity/images/Pasted%2520image%252020250331161239.png)
...
![](cybersecurity/images/Pasted%2520image%252020250331162253.png)

Let's use the cookie and visualize the admin page:

![](cybersecurity/images/Pasted%2520image%252020250331162423.png)
...
![](cybersecurity/images/Pasted%2520image%252020250331163239.png)

The url seems odd, we can test stuff like `LFI` or `SQLI` payload:

![](cybersecurity/images/Pasted%2520image%252020250331163332.png)
...
![](cybersecurity/images/Pasted%2520image%252020250331164347.png)
...
![](cybersecurity/images/Pasted%2520image%252020250331164802.png)
...
![](cybersecurity/images/Pasted%2520image%252020250331165002.png)
...
![](cybersecurity/images/Pasted%2520image%252020250331170833.png)
...
![](cybersecurity/images/Pasted%2520image%252020250331170920.png)
...
![](cybersecurity/images/Pasted%2520image%252020250331172216.png)
...
![](cybersecurity/images/Pasted%2520image%252020250331172248.png)
...
![](cybersecurity/images/Pasted%2520image%252020250331172348.png)
