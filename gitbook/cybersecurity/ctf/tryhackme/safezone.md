...
![](gitbook/cybersecurity/images/Pasted%20image%2020250519124539.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250519125535.png)

Let's go to `register.php` to register an account:

![](gitbook/cybersecurity/images/Pasted%20image%2020250519125628.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020250519125701.png)

We got some tabs, if we go to `news.php`, we can see this:

![](gitbook/cybersecurity/images/Pasted%20image%2020250519125732.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020250519125742.png)

`contact.php` does not exist, let's go to `details.php`:

![](gitbook/cybersecurity/images/Pasted%20image%2020250519125820.png)

Inside of here, we can find this:

![](gitbook/cybersecurity/images/Pasted%20image%2020250519125840.png)

Based on the info, there seems to be some sort of `LFI` inside of here, let's use Caido:

![](gitbook/cybersecurity/images/Pasted%20image%2020250519130341.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250519131015.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250519193418.png)

We are now able to get access to the admin panel, let's check the `details.php` page:

![](gitbook/cybersecurity/images/Pasted%20image%2020250519193521.png)

As seen, it changed, `LFI` works now, knowing this, we can achieve `RCE` using this:

![](gitbook/cybersecurity/images/Pasted%20image%2020250519195900.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250519203456.png)

As seen, we got `rce`, let's do the command from before then:

![](gitbook/cybersecurity/images/Pasted%20image%2020250519203554.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020250519203603.png)

We got the request on our server, we only need to access the file through the `lfi` again and have our listener ready:

![](gitbook/cybersecurity/images/Pasted%20image%2020250519203655.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020250519203704.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250519203804.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250519203911.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250519204031.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250519211619.png)

Let's use linpeas:

![](gitbook/cybersecurity/images/Pasted%20image%2020250519211933.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250519212024.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250519212128.png)

If we inspect the source code, we can find this:

![](gitbook/cybersecurity/images/Pasted%20image%2020250519212145.png)

There's a `login.js` file, inside of it, we can find this:

![](gitbook/cybersecurity/images/Pasted%20image%2020250519212206.png)

We got credentials, once we login, we can see this:

![](gitbook/cybersecurity/images/Pasted%20image%2020250519212235.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250519212359.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020250519212410.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250519213847.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250519213957.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250519214356.png)
