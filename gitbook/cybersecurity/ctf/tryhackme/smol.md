...
![](cybersecurity/images/Pasted%2520image%252020250127152542.png)

After going to the website, this the first thing we encounter, if we keep digging, we find the following:

![](cybersecurity/images/Pasted%2520image%252020250127152619.png)

![](cybersecurity/images/Pasted%2520image%252020250127152626.png)
...
![](cybersecurity/images/Pasted%2520image%252020250127155936.png)
...
![](cybersecurity/images/Pasted%2520image%252020250127160431.png)
...
![](cybersecurity/images/Pasted%2520image%252020250127160614.png)
...
![](cybersecurity/images/Pasted%2520image%252020250127161117.png)

We can see the following line on the code, let's decode the base64:

![](cybersecurity/images/Pasted%2520image%252020250127161206.png)
...
![](cybersecurity/images/Pasted%2520image%252020250127161313.png)
...
![](cybersecurity/images/Pasted%2520image%252020250127161615.png)
...
![](cybersecurity/images/Pasted%2520image%252020250127161756.png)

As we can see, we got a shell, let's make it [[CYBERSECURITY/Commands/Shell Tricks/STABLE SHELL.md|stable]]
![](cybersecurity/images/Pasted%2520image%252020250127161921.png)
...
![](cybersecurity/images/Pasted%2520image%252020250127161957.png)
...
![](cybersecurity/images/Pasted%2520image%252020250127162224.png)

Most important one would be `wp_users`, let's list its contents:

![](cybersecurity/images/Pasted%2520image%252020250127162347.png)

We can filter it our by using: `select user_login,user_pass from wp_users;`:

![](cybersecurity/images/Pasted%2520image%252020250127162418.png)
...
![](cybersecurity/images/Pasted%2520image%252020250127163116.png)

After a while, we get the password for user `diego`,  let's switch users:

![](cybersecurity/images/Pasted%2520image%252020250127163150.png)

Nice, let's check our privileges and group memberships:

![](cybersecurity/images/Pasted%2520image%252020250127163238.png)
...
![](cybersecurity/images/Pasted%2520image%252020250127163341.png)

If we read `think`'s home, we can discover `.ssh`, let's check if there's any `id_rsa`:

![](cybersecurity/images/Pasted%2520image%252020250127163419.png)

Lucky, let's copy the contents and login using ssh:


![](cybersecurity/images/Pasted%2520image%252020250127163545.png)

We can now check the PAM configuration for `su`:

![](cybersecurity/images/Pasted%2520image%252020250127163711.png)
...
![](cybersecurity/images/Pasted%2520image%252020250127163759.png)

Let's check our home directory:

![](cybersecurity/images/Pasted%2520image%252020250127163843.png)

We got a file `wordpress.old.zip`, let's send it to our machine:


![](cybersecurity/images/Pasted%2520image%252020250127164218.png)
...
![](cybersecurity/images/Pasted%2520image%252020250127164351.png)

Password is: `hero_gege@hotmail.com`, let's unzip the file:


![](cybersecurity/images/Pasted%2520image%252020250127164502.png)

We got a `wp-config.php` file:

![](cybersecurity/images/Pasted%2520image%252020250127164524.png)

We got the credentials for `xavi`:`P@ssw0rdxavi@`

![](cybersecurity/images/Pasted%2520image%252020250127164554.png)

Let's check our privileges:

![](cybersecurity/images/Pasted%2520image%252020250127164617.png)

We can run any command, let's simply switch to root and get both flags:

![](cybersecurity/images/Pasted%2520image%252020250127164658.png)

![](cybersecurity/images/Pasted%2520image%252020250127164744.png)
...
![](cybersecurity/images/Pasted%2520image%252020250127164841.png)
