...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529134856.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529135321.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529135808.png)

If we go to `your dashboard`, we get this url:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529135828.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529140149.png)


Knowing this info, we can try brute forcing using `wpscan` too, there's a `wp-login.php` page we can find:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529140506.png)

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529140518.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529141114.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529141427.png)

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529141513.png)

As seen, we got access to the admin panel, on here, we can check this on the posts:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529141550.png)

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529141610.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529141847.png)

On here, add a reverse shell:


![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529141925.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529142034.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529142155.png)

There we go, now we can look around, let's use `linpeas`:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529142819.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529142909.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529143436.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529143832.png)

We can see our request, let's send it to automate:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529144006.png)

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529144538.png)

Run it and check:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529144940.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529145030.png)

Inside of `jenkins`, we can use `Script Console` to get ourselves a reverse shell as `jenkins`, let's do it:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529145112.png)

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529145118.png)

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529145132.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529145235.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529145512.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529145945.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529150034.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250529150108.png)
