...
![](gitbook/cybersecurity/images/Pasted%20image%2020250319153505.png)

We are dealing with a simple apache2 server, let's check source code:

![](gitbook/cybersecurity/images/Pasted%20image%2020250319153549.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250319160218.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250319160355.png)

Let's check `robots.txt`:

![](gitbook/cybersecurity/images/Pasted%20image%2020250319165903.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250319170006.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250320153453.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250320153627.png)

We got a `workshare` directory, this is what's inside of it:

![](gitbook/cybersecurity/images/Pasted%20image%2020250320153757.png)

We got a `New_site.txt` file, let's read it:

![](gitbook/cybersecurity/images/Pasted%20image%2020250320154014.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250320154354.png)

If we go to the link, we can see this:

![](gitbook/cybersecurity/images/Pasted%20image%2020250320154411.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250320154709.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020250320154734.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250320155431.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250320155547.png) And there it is, there's our `id_rsa` file:
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250320155928.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250320160024.png)

We can run `/home/gyles/admin_checks` as `gyles`, let's read the file to know what we're dealing with:

![](gitbook/cybersecurity/images/Pasted%20image%2020250320160152.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250320160722.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250320161545.png)

There we go, let's look around, it's a good time to use linpeas:

![](gitbook/cybersecurity/images/Pasted%20image%2020250320162004.png)

We can write on a weird script, maybe we are missing something, let's use `pspy` to check on the processes:

![](gitbook/cybersecurity/images/Pasted%20image%2020250320162821.png)

We can check root is running some scripts, let's try to modify the `script.sh` file:

![](gitbook/cybersecurity/images/Pasted%20image%2020250320163042.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250320164122.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250320164209.png)
