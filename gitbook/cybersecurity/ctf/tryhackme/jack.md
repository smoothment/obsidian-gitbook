...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617125606.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617125947.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617132550.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617132639.png)


![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617132721.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617153937.png)


Basically, we need to intercept the request and change a parameter, let's do it:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617154114.png)

Click on Update Profile:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617154612.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617154700.png)

Once we send the request, we notice our dashboard changed:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617154828.png)

We got new functionalities, we can get a shell through the `plugin editor`:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617154915.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617155345.png)



Save it and now we need to trigger it:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617155131.png)

To trigger it, we need to go to `Installed Plugins` and activate it:


![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617155159.png)

If we check our listener:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617155405.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617155558.png)

Now we're good to go, let's check users:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617155642.png)

We only got `jack`, let's check his home:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617155725.png)

We got a `reminder.txt` file:


![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617155949.png)

They talking bout some backups, let's use linpeas to check that:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617161259.png)

As seen, inside of `/var/backups` we can find the `id_rsa` for jack, let's grab it and get into ssh:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617161410.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617161855.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617162155.png)

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617162303.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617162534.png)

Now, save it and start the listener, once the script runs again, we will receive a shell:

![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617162645.png)
...
![](CYBERSECURITY/IMAGES/Pasted%20image%2020250617162752.png)
