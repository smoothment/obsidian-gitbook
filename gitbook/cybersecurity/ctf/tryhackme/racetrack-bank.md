...
![](cybersecurity/images/Pasted%2520image%252020250612145657.png)
...
![](cybersecurity/images/Pasted%2520image%252020250612150609.png)

![](cybersecurity/images/Pasted%2520image%252020250612151210.png)

We got a purchase functionality on here too, we can check it out:

![](cybersecurity/images/Pasted%2520image%252020250612151246.png)
...
![](cybersecurity/images/Pasted%2520image%252020250612151403.png)
...
![](cybersecurity/images/Pasted%2520image%252020250612151455.png)

![](cybersecurity/images/Pasted%2520image%252020250612151516.png)

![](cybersecurity/images/Pasted%2520image%252020250612151528.png)

If we check our first account:

![](cybersecurity/images/Pasted%2520image%252020250612151603.png)
...
![](cybersecurity/images/Pasted%2520image%252020250612152318.png)
...
![](cybersecurity/images/Pasted%2520image%252020250612152600.png)

As seen, there's only race conditions for this, if we investigate further, we can find the package too:


![](cybersecurity/images/Pasted%2520image%252020250612152928.png)
...
![](cybersecurity/images/Pasted%2520image%252020250612153022.png)
...
![](cybersecurity/images/Pasted%2520image%252020250612153415.png)

We will see all the requests being made, what we need to do now is check `test2` account:

![](cybersecurity/images/Pasted%2520image%252020250612153459.png)
...
![](cybersecurity/images/Pasted%2520image%252020250612155205.png)

We need to check `acc2`:

![](cybersecurity/images/Pasted%2520image%252020250612155224.png)

As seen, we got the amount of gold the script told us, let's buy our premium account:

![](cybersecurity/images/Pasted%2520image%252020250612155301.png)

Once we buy it, we get access to `Premium Features`, let's check them out:

![](cybersecurity/images/Pasted%2520image%252020250612155322.png)

A calculator huh, seems weird:


![](cybersecurity/images/Pasted%2520image%252020250612161556.png)
...
![](cybersecurity/images/Pasted%2520image%252020250612162032.png)
...
![](cybersecurity/images/Pasted%2520image%252020250612162333.png)
...
![](cybersecurity/images/Pasted%2520image%252020250612162428.png)
Now, let's take a look around, we can use linpeas:

![](cybersecurity/images/Pasted%2520image%252020250612162926.png)
...
![](cybersecurity/images/Pasted%2520image%252020250612163145.png)
...
![](cybersecurity/images/Pasted%2520image%252020250612164012.png)
...
![](cybersecurity/images/Pasted%2520image%252020250612164116.png)
