...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620151650.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620152619.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020250620152626.png)

Both seem the same at first sight but if we check closer, on `it.k2.thm`, we can sign up, let's do it:

![](gitbook/cybersecurity/images/Pasted%20image%2020250620152721.png)

What's weird on here is the email ID, let's send a test request on a proxy to analyze the response:

![](gitbook/cybersecurity/images/Pasted%20image%2020250620152846.png)

Based on the request, we don't need some sort of numerical id, let's try a simple test email:

![](gitbook/cybersecurity/images/Pasted%20image%2020250620152931.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620153046.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620153530.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620154546.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620154821.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620154903.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620155225.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020250620155237.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620155324.png)

Once we send the request, if we had our python server up, we can see this:

![](gitbook/cybersecurity/images/Pasted%20image%2020250620155406.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620164325.png)

Now we got access to the `admin` dashboard, we can see the following:

![](gitbook/cybersecurity/images/Pasted%20image%2020250620164359.png)

On here, we can select the ticket title, let's check the request on a proxy:

![](gitbook/cybersecurity/images/Pasted%20image%2020250620165433.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620165604.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020250620165612.png)

As seen, we get an internal server error, which is pretty weird actually but if we use a full payload:

![](gitbook/cybersecurity/images/Pasted%20image%2020250620165742.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020250620165751.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620170056.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620170249.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620171653.png)

The third one changes length and status code:

![](gitbook/cybersecurity/images/Pasted%20image%2020250620171717.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620172233.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620172348.png)

We found the tables, let's drop columns on admin\_auth and auth\_users:
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620172455.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620172652.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620173003.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620173429.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620174014.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620174105.png)

Weird, they don't work for rose, if we try them on root, this happens:

![](gitbook/cybersecurity/images/Pasted%20image%2020250620174144.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620174251.png)
...
We still need to find `rose`'s password, if we check bash\_history, we can find it:
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250620174607.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250621001002.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250621004311.png) Last credentials work for `winrm`, we can go into that:

```
evil-winrm -i K2Server -u 'r.bud' -p 'c'
```

![](gitbook/cybersecurity/images/Pasted%20image%2020250621004424.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250621010353.png)

We got some users, let's check `j.bold` for example:

![](gitbook/cybersecurity/images/Pasted%20image%2020250621010427.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250621010713.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250621012140.png) Here's an article about `GenericAll` exploitation if you didn't understand what was done here:
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250621012229.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250621013349.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250621013706.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250621013831.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250621014831.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250621021941.png)

We are members of `IT DIRECTOR`:

![](gitbook/cybersecurity/images/Pasted%20image%2020250621022004.png)

This group has got `GenericWrite` over `K2ROOTDC.K2.THM`, we can find this on bloodhound:

![](gitbook/cybersecurity/images/Pasted%20image%2020250621022054.png)

![](gitbook/cybersecurity/images/Pasted%20image%2020250621022118.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250621023201.png)
...
![](gitbook/cybersecurity/images/Pasted%20image%2020250621023311.png)
