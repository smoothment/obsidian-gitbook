...
![](images/Pasted%20image%2020250314141610.png)

If we go to register, we can see this:

![](images/Pasted%20image%2020250314141630.png)
...
![](images/Pasted%20image%2020250314181227.png)
...
![](images/Pasted%20image%2020250317143641.png)
...
![](images/Pasted%20image%2020250317143941.png)
...
![](images/Pasted%20image%2020250317144124.png)


We can see this in our python server:

![](images/Pasted%20image%2020250317144147.png)
...
![](images/Pasted%20image%2020250317144245.png)
...
![](images/Pasted%20image%2020250317151014.png)
...
![](images/Pasted%20image%2020250317151210.png)
...
![](images/Pasted%20image%2020250317151521.png)
...
![](images/Pasted%20image%2020250317152103.png)

We got a stable shell now, let's look around, we got this:

![](images/Pasted%20image%2020250317152134.png)

Got a `config.php` file, let's read it:

![](images/Pasted%20image%2020250317152150.png)
...
![](images/Pasted%20image%2020250317154806.png)


We can now access the db:

![](images/Pasted%20image%2020250317155125.png)


We can find this inside the db:

![](images/Pasted%20image%2020250317155227.png)
...
![](images/Pasted%20image%2020250317155600.png)

If we use MD5 again:

![](images/Pasted%20image%2020250317155615.png)
...
![](images/Pasted%20image%2020250317155933.png)

Let's check our privileges:

![](images/Pasted%20image%2020250317160010.png)

We can use `curl` with wildcard as the user `dolivaw`, let's check GTFOBINS:

![](images/Pasted%20image%2020250317164324.png)
...
![](images/Pasted%20image%2020250317164513.png)

But, what we need to find is who this file belongs to, either `dolivaw` or our user:

![](images/Pasted%20image%2020250317164614.png)
...
![](images/Pasted%20image%2020250317165458.png)

At this point we can read `user.txt` but let's continue onto root, let's check our privileges:


![](images/Pasted%20image%2020250317165535.png)

Let's search this on GTFOBINS:


![](images/Pasted%20image%2020250317165608.png)
...
![](images/Pasted%20image%2020250317170005.png)
