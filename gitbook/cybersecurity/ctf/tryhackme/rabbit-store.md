...
![](cybersecurity/images/Pasted%2520image%252020250226145915.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226150256.png)


We got a login section, let's take a look:

![](cybersecurity/images/Pasted%2520image%252020250226150811.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226151210.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226151727.png)

Let's check the request in burp:

![](cybersecurity/images/Pasted%2520image%252020250226152008.png)


![](cybersecurity/images/Pasted%2520image%252020250226152021.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226152958.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226153148.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226153239.png)

And it worked:

![](cybersecurity/images/Pasted%2520image%252020250226153250.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226153346.png)

And now, it's changed to active, let's check the panel now:


![](cybersecurity/images/Pasted%2520image%252020250226153426.png)

![](cybersecurity/images/Pasted%2520image%252020250226153434.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226154538.png)

![](cybersecurity/images/Pasted%2520image%252020250226154547.png)

And we got a link to our file, let's open burp and analyze the request:

![](cybersecurity/images/Pasted%2520image%252020250226154631.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226154759.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226154901.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226155051.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226155815.png)

We were able to do it, let's read the file:

![](cybersecurity/images/Pasted%2520image%252020250226155859.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226160121.png)

As known, it requires a POST request, let's send one with empty data:

![](cybersecurity/images/Pasted%2520image%252020250226160238.png)

If we change our username to `admin` this happens:

![](cybersecurity/images/Pasted%2520image%252020250226160324.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226160441.png)

And that's correct, let's test for `SSTI`:

![](cybersecurity/images/Pasted%2520image%252020250226160538.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226161449.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226161615.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226161731.png)
...
![](cybersecurity/images/Pasted%2520image%252020250226171829.png)
