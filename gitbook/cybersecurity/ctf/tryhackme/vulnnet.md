...
![](cybersecurity/images/Pasted%2520image%252020250401144159.png)

If we check the first one, we can see this:

![](cybersecurity/images/Pasted%2520image%252020250401144226.png)

The code is pretty messy, let's use a beautifier to look at it better:

![](cybersecurity/images/Pasted%2520image%252020250401144258.png)
...
![](cybersecurity/images/Pasted%2520image%252020250401144421.png)
...
![](cybersecurity/images/Pasted%2520image%252020250401145736.png)
...
![](cybersecurity/images/Pasted%2520image%252020250401145938.png)
...
![](cybersecurity/images/Pasted%2520image%252020250401160803.png)
...
![](cybersecurity/images/Pasted%2520image%252020250401161052.png)
...
![](cybersecurity/images/Pasted%2520image%252020250401161201.png)
...
![](cybersecurity/images/Pasted%2520image%252020250401161443.png)
...
![](cybersecurity/images/Pasted%2520image%252020250401161643.png)
...
![](cybersecurity/images/Pasted%2520image%252020250401162216.png)


We are inside something called `ClipBucket`, let's search the version in the source code:

![](cybersecurity/images/Pasted%2520image%252020250401162351.png)

So, `ClipBucket 4.0`, let's search for an exploit:


![](cybersecurity/images/Pasted%2520image%252020250401162441.png)


There we go, we can upload files, if we check `exploit-db`, we can check the following PoC:


![](cybersecurity/images/Pasted%2520image%252020250401162859.png)
...
![](cybersecurity/images/Pasted%2520image%252020250402125929.png)
...
![](cybersecurity/images/Pasted%2520image%252020250402130005.png)

There's a directory, if we follow it, we get to this:

![](cybersecurity/images/Pasted%2520image%252020250402130032.png)


This is our reverse shell, let's set up our listener and get the connection:

![](cybersecurity/images/Pasted%2520image%252020250402130104.png)
...
![](cybersecurity/images/Pasted%2520image%252020250402130331.png)

If we look around, we can find this inside of `/var/backups`:

![](cybersecurity/images/Pasted%2520image%252020250402132010.png)
...
![](cybersecurity/images/Pasted%2520image%252020250402132117.png)
...
![](cybersecurity/images/Pasted%2520image%252020250402132444.png)
...
![](cybersecurity/images/Pasted%2520image%252020250402132806.png)
...
![](cybersecurity/images/Pasted%2520image%252020250402134609.png)
...
![](cybersecurity/images/Pasted%2520image%252020250402134654.png)
