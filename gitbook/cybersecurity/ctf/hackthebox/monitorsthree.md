...
![](cybersecurity/images/Pasted%2520image%252020250117151541.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117152544.png)

We got a login page, we can try to fuzz a bit more: 

![](cybersecurity/images/Pasted%2520image%252020250117153123.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117153315.png)

![](cybersecurity/images/Pasted%2520image%252020250117153335.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117153418.png)

We got a `Forgot Password?` site:

![](cybersecurity/images/Pasted%2520image%252020250117153441.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117153528.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117153712.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117154018.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117160216.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117160345.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117160454.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117160547.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117160631.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117160713.png)


We got the following: `admin：31a181c8372e3afc59dab863430610e8`

![](cybersecurity/images/Pasted%2520image%252020250117160754.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117170018.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117170504.png)

We found credentials for the `mysql` server, let's check what's inside:

![](cybersecurity/images/Pasted%2520image%252020250117170654.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117171224.png)

We got it: `12345678910`, let's switch users:

![](cybersecurity/images/Pasted%2520image%252020250117171336.png)

Nice, next step would be reading `/.ssh/id-rsa`:

![](cybersecurity/images/Pasted%2520image%252020250117171445.png)

Let's copy it into a file and log in using ssh:

![](cybersecurity/images/Pasted%2520image%252020250117171613.png)

In this point, we can already view `user.txt`:

![](cybersecurity/images/Pasted%2520image%252020250117171636.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117172157.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117172239.png)

We find something called duplicate, let's search if there's any way to bypass that login page:

![](cybersecurity/images/Pasted%2520image%252020250117172342.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117172442.png)

First, let's locate where `duplicati` is running on the machine:

![](cybersecurity/images/Pasted%2520image%252020250117172612.png)

We have `/opt/duplicati`:

![](cybersecurity/images/Pasted%2520image%252020250117172643.png)

![](cybersecurity/images/Pasted%2520image%252020250117172655.png)

Following the PoC, we need to download `Duplicati-server.sqlite`:

![](cybersecurity/images/Pasted%2520image%252020250117173054.png)

Nice, next step would be searching for a password, and a salt:

![](cybersecurity/images/Pasted%2520image%252020250117173615.png)

Let's check out `option`:

![](cybersecurity/images/Pasted%2520image%252020250117173635.png)

Next we need to follow is this:

![](cybersecurity/images/Pasted%2520image%252020250117173815.png)

![](cybersecurity/images/Pasted%2520image%252020250117173940.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117174820.png)

If we do everything correctly, we must bypass the login panel:


![](cybersecurity/images/Pasted%2520image%252020250117183156.png)

First thing we see in here is a `Add backup` stuff, let's check it out:

![](cybersecurity/images/Pasted%2520image%252020250117183244.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117184501.png)

![](cybersecurity/images/Pasted%2520image%252020250117184509.png)
...
![](cybersecurity/images/Pasted%2520image%252020250117184631.png)
