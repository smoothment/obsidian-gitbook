...
![](cybersecurity/images/Pasted%2520image%252020250311135818.png)
...
![](cybersecurity/images/Pasted%2520image%252020250311140959.png)
...
![](cybersecurity/images/Pasted%2520image%252020250311164853.png)

If we click it, we are redirected to another subdomain:

![](cybersecurity/images/Pasted%2520image%252020250311164915.png)
...
![](cybersecurity/images/Pasted%2520image%252020250311165040.png)
...
![](cybersecurity/images/Pasted%2520image%252020250311165157.png)

So, let's try to read the `/config/database.yml` file:

![](cybersecurity/images/Pasted%2520image%252020250311165242.png)
...
![](cybersecurity/images/Pasted%2520image%252020250311165424.png)
...
![](cybersecurity/images/Pasted%2520image%252020250311165940.png)
...
![](cybersecurity/images/Pasted%2520image%252020250311172029.png)


In the script there's a `config.xml` file, since this RCE works for older versions, we need to change the file in this way:

![](cybersecurity/images/Pasted%2520image%252020250311171603.png)
...
![](cybersecurity/images/Pasted%2520image%252020250311172151.png)

Let's upload our zip file:

![](cybersecurity/images/Pasted%2520image%252020250311172223.png)

Now, we need to activate:

![](cybersecurity/images/Pasted%2520image%252020250311172253.png)
...
![](cybersecurity/images/Pasted%2520image%252020250311172439.png)
...
![](cybersecurity/images/Pasted%2520image%252020250311173009.png)

And there we are, we now got access to ssh using `ron`, let's use linpeas to look up a way to get into root:

![](cybersecurity/images/Pasted%2520image%252020250311174522.png)

After analyzing the ports, at port `8500` we got a consul web page running:

![](cybersecurity/images/Pasted%2520image%252020250311175002.png)

We can search for an exploit regarding that:

![](cybersecurity/images/Pasted%2520image%252020250311175610.png)



Let's download it and use it:

![](cybersecurity/images/Pasted%2520image%252020250311175740.png)

Our `acl_token` in this case is `1`:

![](cybersecurity/images/Pasted%2520image%252020250311175801.png)

If we check our listener:

![](cybersecurity/images/Pasted%2520image%252020250311175815.png)
...
![](cybersecurity/images/Pasted%2520image%252020250311175926.png)
