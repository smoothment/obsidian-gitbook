...
![](gitbook/cybersecurity/images/Pasted%20image%2020241028170413.png)
...
Another mathematical operation we often encounter in cryptography is the modulo operator, commonly written as % or as _m\_\_o\_\_d_. The modulo operator, _X_%_Y_, is the **remainder** when X is divided by Y. In our daily life calculations, we focus more on the result of division than on the remainder. The remainder plays a significant role in cryptography.
...
![](gitbook/cybersecurity/images/Pasted%20image%2020241028171252.png)
